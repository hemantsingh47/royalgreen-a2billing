...
if (empty($id)) {
    header("Location: billing_entity_logrefill.php?atmenu=payment&section=2");
}
...
<table style="width : 100%;" class="editform_table1">
...
<div style="width : 100%; text-align : right; margin-left:auto;margin-right:auto;" >
     <a class="cssbutton_big"  href="billing_entity_logrefill.php?atmenu=payment&section=2">
