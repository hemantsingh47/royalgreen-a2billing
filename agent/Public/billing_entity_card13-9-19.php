...
/********************************* BATCH UPDATE ***********************************/
    ...
    color: #;
          ...
          <h5> <span class="icon"> <i class="flaticon-list-2"></i> </span> <?php echo gettext("Batch Update");?> <b>&nbsp;<?php echo $HD_Form -> FG_NB_RECORD ?></b> <?php echo gettext("cards selected!"); ?>
                ...
                ?>
                    ...
                    <div class="control-group" style="margin-top: 10px; height: auto; margin-bottom: 10px;">
                                                    <label class="control-label" style="width:30%;"> 
                                                            ...
                                                            <?php echo gettext("Description");?>
                                                             ...
                                                             <div class="">
                                                             <input class="form-control13" name="upd_description"  size="20" maxlength="20"  value="<?php if (isset($upd_description)) echo $upd_description;?>"><br/>
                    ...
                    <div class="control-group" style="margin-top: 10px; height: auto; margin-bottom: 10px;">
                                                    <label class="control-label" style="width:30%;">
                                                      ...
                                                      <div class="">
                                                                 <input class="form-control13" name="upd_creditlimit" size="10" maxlength="10"  value="<?php if (isset($upd_creditlimit)) echo $upd_creditlimit; else echo '0';?>" > <br>
                    ...
                    <div class="control-group" style="margin-top: 10px; height: auto; margin-bottom: 10px;">
                                                    ...
                                                    <div class="">
                                                        <input class="form-control13"  name="upd_expirationdate" size="20" maxlength="30" <?php echo $comp_date_plus; ?>> <font class="version"><i style="font-size: 12px"> <br> <?php echo gettext("(Format YYYY-MM-DD HH:MM:SS)");?></i></font>
                                                        </div>
                                                        </div>
