...
<!-- new theme login page css -->
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(templates/default/newtheme/theme/classic/assets/media//bg/bg-1.jpg);">
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								...
								<div style="color:#ffff00;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:bold;text-align:center;padding-top:20px" >
      								{if ($error == 1)}
    								...
    								{/if}
								<form name="form" method="POST" action="dashboard.php" onSubmit="return test()" class="kt-form"  onSubmit="return test()">
								<input type="hidden" name="done" value="submit_log">
									<div class="input-group">
										<input class="form-control" type="text" id="login_username" name="pr_login"  placeholder="Username" />
										
									</div>
									<div class="input-group">
										<input class="form-control" input type="password" id="login_password" name="pr_password" placeholder="Password" />
									</div>
									<div class="row kt-login__extra">
										...
										<select id="ui_language" name="ui_language" class="flip-link btn btn-info">
									...
									<div class="kt-login__actions">
										<button id="kt_login_signin_submit" type="submit" class="btn btn-pill kt-login__btn-primary">Sign In</button>
									</div>
								</form>
								</div>
							</div>							
