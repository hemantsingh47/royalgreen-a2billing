...
<div class="modal fade" id="kt_modal_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
     <div class="modal-dialog" role="document">
       ...
       <table width="90%" border="0" align="center">
        <tr>
            <td align="left" width="50%" class="bgcolor_001" valign="top">
               <table>
            <tr><td align="center">
               <table>
			   <tr>
			   ...
			   <td><input class="form-control" name="choose_list" onfocus="clear_textbox2();" size="18" maxlength="16" value="enter ID Card"></td>
			   <td>
            ...
            <tr><td align="center">
                 <table>
			   <tr>
			   <td><?php echo gettext("CARDNUMBER");?>:</td>
        ...
        <td  class="bgcolor_001" align="center">
            <table>
                <tr>
                    ...
                    <td>
                        <input class="form-control" name="addcredit" size="18" maxlength="6" value=""> </td>
