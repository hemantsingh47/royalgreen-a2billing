...
//$FG_TABLE_COL[]=array ("Sr. No.", "srn", "10%", "center", "SORT");
				...
				<div class="kt-section">
						...
						<table class="table">
						  	<tbody>
						    	<tr>
							      	...
							      	<td> <input type="radio" name="Period" value="Month" <?php  if (($Period=="Month") || !isset($Period)) { ?>checked="checked" <?php  } ?>>
                    <font class="fontstyle_003"><?php echo gettext("SELECT BY MONTH");?></b></font></td>
                    ...
                    ?>
						    	...
						    	<tr>
						      		...
						      		<td><input type="radio" name="Period" value="Day" <?php  if ($Period=="Day") { ?>checked="checked" <?php  } ?>>
                    <font class="fontstyle_003"><?php echo gettext("SELECT BY DAY");?></b></font></td>
						      		<td><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                    <tr><td class="fontstyle_searchoptions">
...
<!-- ** ** ** ** ** Part to display the CDR ** ** ** ** ** -->
     ...
     <table width="<?php echo $FG_HTML_TABLE_WIDTH?>" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-bordered" style="background: #fff;">
        <TR>
          <TD class="callhistory_td11" style="border:0;">
            <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
               <TR>
                  <TD style="font-size: 1.2rem; color: #464457;font-weight: 500;"><?php echo $FG_HTML_TABLE_TITLE?></TD>
                </TR>
            </TABLE></TD>
        </TR> 
        <TR>
...
<TBODY>
                <TR>
                  <th width="<?php echo $FG_ACTION_SIZE_COLUMN?>" align=center class="tableBodyRight"> </th>

                  <?php
                      if (is_array($list) && count($list)>0) {
                      for ($i=0;$i<$FG_NB_TABLE_COL;$i++) {
                    ?>
                   <th class="tableBody" align="center" width="<?php echo $FG_TABLE_COL[$i][2]?>" >
                        <strong>
