...
?>
      ...
      <table class="infoBox" width="80%" cellspacing="0" cellpadding="2" align=center>
          <tr height="20">
          <td  align=left class="main" style="width:70%;"> <b>Continue Checkout Procedure to confirm this order</b>

          </td>
          <td align=left>
            <input type="submit" alt="Continue" border="0" value="Continue" class="btn btn-brand">
             </td>
          </tr>
         </table>
         <?php } ?>
