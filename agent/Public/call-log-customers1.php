...
<TABLE class="bar-status" width="95%" border="0" cellspacing="1"
    cellpadding="2" align="center">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td class="fontstyle_searchoptions" width="400" valign="top">
                    <?php
            echo gettext ( "Enter the customer ID" );?>: <INPUT TYPE="text"
            ...
            echo $entertariffgroup?>" size="4" class="form_input_text">&nbsp;<a href="#" onclick="window.open('billing_entity_card.php?popup_select=1&popup_formname=myForm&popup_fieldname=entercustomer' , 'CallPlanSelection','scrollbars=1,width=550,height=330,top=20,left=100');"><img
                            src="<?php echo Images_Path; ?>/icon_arrow_orange.gif"></a></td>
    ...
    <tr>
        <td align="left"><font class="fontstyle_003">&nbsp;&nbsp;<?php
...
<div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h4 style="margin:4px;"><?php echo gettext ( "Call Details" );?></h4> 
<h4 style="text-align:center;margin:30px;"><?php
echo gettext ( "Number of call" );?> : <?php if (is_array ( $list ) && count ( $list ) > 0) { echo $nb_record;} else { echo "0";}?>
   </h4></div>
          <div class="widget-content nopadding">
		  
<table width="<?php echo $FG_HTML_TABLE_WIDTH?>" border="0"align="center" cellpadding="0" cellspacing="0" class="table table-bordered table-striped with-check">
