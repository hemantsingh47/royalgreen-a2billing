            ...
            <tr>
                <td align="left" style="vertical-align: middle;">
                  ...
                  <td align="left">
                    ...
                    <tr><td class="fontstyle_searchoptions" style="border:0;    padding-left: 0;">
                      <input type="checkbox" name="frommonth" value="true" <?php  if ($frommonth) { ?>checked<?php }?>>
                    <?php echo gettext("From");?> : <select name="fromstatsmonth" class="form-control" style="width:83%">
                    <?php
                    ...
                    </td><td  class="fontstyle_searchoptions" style="border:0;     padding-left: 0;">
                    <input type="checkbox" name="tomonth" value="true" <?php  if ($tomonth) { ?>checked<?php }?>>
                    <?php echo gettext("To");?> : <select name="tostatsmonth" class="form-control13" style="width:83%">
