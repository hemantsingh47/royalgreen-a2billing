...
<div class="kt-portlet">
   ...
   <tr height="20px">
       ...
       <tr height="20px">
        ...
        <td class="tableBodyRight" >
            <a href="billing_refill_info_agent.php?id=<?php echo $payment['id_logrefill']?>"> <img src="<?php echo Images_Path."/link.png"?>" border="0" title="<?php echo gettext("Link to the refill")?>" alt="<?php echo  gettext("Link to the refill")?>"></a>
        </td>
    </tr>
       <?php } ?>
...
<div style="width : 100%; text-align : right; margin-left:auto;margin-right:auto;" >
     <a class="btn btn-primary"  href="billing_entity_payment_agent.php?atmenu=payment&section=10">
        <!-- <img src="<?php echo Images_Path_Main;?>/icon_arrow_orange.gif"/> -->
        <?php echo gettext("AGENT'S PAYMENTS LIST"); ?>
    </a>
</div>
