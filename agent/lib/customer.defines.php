...
define ("NEXMO_USERNAME", isset($A2B->config['global']['nex_username'])?$A2B->config['global']['nex_username']:null);
define ("NEXMO_PASSWORD", isset($A2B->config['global']['nex_password'])?$A2B->config['global']['nex_password']:null);
