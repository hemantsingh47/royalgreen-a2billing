...
<div class="kt-portlet">
    ...
    <TABLE  class="" style="width:80%;" align="center">
    ...
    <?php
        for ($i=0;$i<$this->FG_NB_TABLE_ADITION;$i++) {
            ...
            if (strlen($this->FG_TABLE_ADITION[$i][16])>1 && strtoupper ($this->FG_TABLE_ADITION[$i][3])!=("HAS_MANY")) {
                echo '<TR><TD colspan="2" width="100%" valign="top"  ><strong style="font-size:14px"><i>';
                echo $this->FG_TABLE_EDITION[$i][16];
                echo '</i></strong><hr/></TD></TR>';
            }
    ...
    ?>
            ...
            <TD width="35%" valign="middle" align="left" > 		<?php echo $this->FG_TABLE_ADITION[$i][0]?> 		</TD>
              <TD width="65%" valign="top" style="padding-left: 5%;" >
        <?php } else { ?>
            <TD width="35%" valign="middle" align="left"  > 		<?php echo $this->FG_TABLE_ADITION[$i][0]?> 		</TD>
            <TD width="65%" valign="top" style="padding-left: 5%;" >
        <?php } ?>
    ...
    ?>
        <div class="form-group"><span class="md-input-bar "></span></div>
        <INPUT class="md-input" name=<?php echo $this->FG_TABLE_ADITION[$i][1]?>  <?php echo $this->FG_TABLE_ADITION[$i][4]?> value="<?php
            ...
            } else { echo $processed[$this->FG_TABLE_ADITION[$i][1]]; }?>"><span class="md-input-bar "></span></div>
...
<!--CAPTCHA IMAGE CODE START HERE-->
    ...
    ?>
        <table cellpadding="2" cellspacing="0" border="0" width="100%">
            ...
            <tr>
            <td>
            <div class="md-input-wrapper"><span class="md-input-bar "></span></div>
...
<!--CAPTCHA IMAGE CODE END HERE-->
    ...
    <?php   	}
      ...
      <TABLE cellspacing="0" class="" style="width:80%;margin-top:10px">
        <tr>
