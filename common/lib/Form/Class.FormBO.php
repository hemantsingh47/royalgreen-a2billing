...
/**
    ...
    */
    ...
    //new function for sip buddies change
    public static function create_status_log_withsipiax()
    {
        $FormHandler = FormHandler::GetInstance();
        $processed = $FormHandler->getProcessed();
        $status = $processed['status'];
        ...
        $secret=$processed['uipass'];
        $id_cc_card=$processed['id'];
        $sip=$processed['sip_buddy'];
        $iax=$processed['iax_buddy'];
        ...
        else
        {
            ...
            //echo '<script>alert("'.$sip.$iax.'");</script>';
            $instance_realtime = new Realtime();
            $instance_realtime -> update_voip_config ($sip, $iax, $id_cc_card, $username, $secret);
