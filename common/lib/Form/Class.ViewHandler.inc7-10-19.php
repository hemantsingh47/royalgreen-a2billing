...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" style="width: 97%;
    margin: 0 auto;">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__head kt-portlet__head--lg" style="padding:0px;">
				...
				<div class="kt-portlet__head-title" style="padding:0"> <span class="icon "><i class="icon-th"></i></span>
                        ...
                        <?php if ($this->CV_DISPLAY_RECORD_LIMIT){ ?>
                            ...
                            <?php
                             ...
                             ?> 
										...
										<input class="btn btn-success btn-mini"  value=" <?php echo gettext("GO");?> " type="SUBMIT" style="width:50px;">
                ...
                ?>
                <div style="position: static;float: right;font-size: 12px;line-height: 28px;margin-top: 0px;">
                    ...
                    <?php
					 ...
					 <INPUT type="hidden" name="form_action" value="<?php echo $this->FG_FILTER_FORM_ACTION ?>">
                                    ...
                                    { ?>
                                        ...
                                        <INPUT type="text" name="filterprefix" value="<?php if(!empty($processed['filterprefix'])) echo $processed['filterprefix']; ?>" class="md-input label-fixed" style="height:25px; width:120px;">
                                    ...
                                    ?>
                                    <input type="SUBMIT" value="<?php echo gettext("APPLY FILTER ");?>" class="btn btn-success" style="margin-top: 0px;margin-right: 3px; width:100px;"/> 
                                </FORM>
                            </div>
						<?php } ?>
               ...
               <?php  IF ($this -> CV_DISPLAY_FILTER_ABOVE_TABLE){ ?>
				...
				<TR <?php 
                        ...
                        for($i=0;$i<$this->FG_NB_TABLE_COL;$i++) 
                        {
							...
							<!--<TD vAlign="top" align="<?php echo $this->FG_TABLE_COL[$i][3]?>" class="kt-datatable__cell" style="">-->
							<TD vAlign="top" style="text-align: left;color: #666;font-size: 0.9rem;">
							<?php
      ...
      <?php  } ?>
                            ...
                            {?>
                              <TD align="center" vAlign=top style="white-space: normal; padding: 0.70rem 0.30rem 0.30rem 0.30rem;">
