...
class sslcommerz
{
    ...
    {
        $this->data['value_a'] = (isset($info['key'])) ? $info['key'] : null; // value_a [ string (255) - Extra parameter to pass your meta data if it is needed. Not mandatory]
        $this->data['value_b'] = (isset($info['sess_id'])) ? $info['sess_id'] : null; // value_b [ string (255) - Extra parameter to pass your meta data if it is needed. Not mandatory]
