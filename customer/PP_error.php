...
$error["0"] = gettext("Your Session has been Expired, please login again!");
...
$error["accessdenied"] = gettext("Your Session has been Expired, please login again!");
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v6" style="background-image: url(templates/default/newtheme/theme/classic/assets/media/error/bg6.jpg);">
				<div class="kt-error_container">
					...
					<div class="kt-login__options">
						<button class ="btn btn-secondary" Style="background-color: white"> <a href="index.php" >
										&nbsp;&nbsp;&nbsp; GO TO LOGIN PAGE &nbsp;&nbsp;&nbsp; 
						</a> </button>
					</div>
				</div>
