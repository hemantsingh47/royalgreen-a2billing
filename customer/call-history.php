...
<div class="col-md-12">
		<!--begin::Portlet-->
		<div class="kt-portlet">
 <table border="0" cellspacing="0" cellpadding="0" width="100%" class="table table-bordered"style="background:22#e1e1e1;"><tr><td class="callhistory_td1" align="left" ><b><?php echo gettext("SUMMARY");?></b></td></tr>
            </table>
...
<tr><td>
    ...
    <tr>
        ...
        <td class="callhistory_td3" align="left" colspan="5" style="padding: 0.10rem; background:#e1e1e1; border-bottom:1px solid; padding:5px;"><b><?php echo gettext("CALLING CARD MINUTES");?></b></td><td class="callhistory_td3" align="left" colspan="5" style="padding: 0.10rem; background:#e1e1e1; border-bottom:1px solid;"></td>
    </tr>
    <tr>
        <td align="left" class="callhistory_td3" width="10%"style="background:#e1e1e1;"><?php echo gettext("DATE");?></td>
        <td align="left" class="callhistory_td2" width="10%" style="background:#e1e1e1;"><?php echo gettext("DURATION");?></td>
        <td align="left" class="callhistory_td2" width="50%" style="background:#e1e1e1;"><?php echo gettext("GRAPHIC");?></td>
        <td align="left" class="callhistory_td2" width="10%" style="background:#e1e1e1;"><?php echo gettext("CALLS");?></td>
        <td align="left" class="callhistory_td2" width="10%" style="background:#e1e1e1;"><acronym title="<?php echo gettext("AVERAGE LENGTH OF CALL");?>"><?php echo gettext("ALOC");?></acronym></font></td>
        <td align="left" class="callhistory_td2" width="10%" style="background:#e1e1e1;"><?php echo gettext("TOTAL COST");?></td>
    ...
    <?php
        ...
        ?>
            ...
            <td align="left" class="sidenav" nowrap="nowrap"><font class="callhistory_td5"><?php echo $data[0]?></font></td>
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="left" nowrap="nowrap" class="fontstyle_001"><?php echo $minutes?> </td>
            ...
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="left" nowrap="nowrap" class="fontstyle_001"><?php echo $data[3]?></td>
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="left" nowrap="nowrap" class="fontstyle_001" ><?php echo $tmc?> </td>
            <td bgcolor="<?php echo $FG_TABLE_ALTERNATE_ROW_COLOR[$i]?>" align="left" nowrap="nowrap" class="fontstyle_001"><?php  display_2bill($data[2]) ?></td>
         <?php
         }
    ...
    <tr class="callhistory_td2">
        <td align="left" nowrap="nowrap" class="callhistory_td4" style="background:#e1e1e1;"><b><?php echo gettext("TOTAL");?></b></td>
        <td align="left" nowrap="nowrap" colspan="2" class="callhistory_td4" style="background:#e1e1e1;"><b><?php echo $totalminutes?></b> </td>
        <td align="left" nowrap="nowrap" class="callhistory_td4" style="background:#e1e1e1;"><b><?php echo $totalcall?></b></td>
        <td align="left" nowrap="nowrap" class="callhistory_td4" style="background:#e1e1e1;"><b><?php echo $total_tmc?></b></td>
        <td align="left" nowrap="nowrap" class="callhistory_td4" style="background:#e1e1e1;"><b><?php  display_2bill($totalcost) ?></b></td>
    </tr>
