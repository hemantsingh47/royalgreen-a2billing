...
if( !($popup_select>=1) &&($this->FG_LIST_ADDING_BUTTON1 || $this->FG_LIST_ADDING_BUTTON2)) {
    ...
    <table align="left"><tr align="left">
        ...
        <?php if($this->FG_LIST_ADDING_BUTTON1) {?>
            <!--<a class="btn btn-primary btn-small" href="<?php echo $this -> FG_LIST_ADDING_BUTTON_LINK1    ?>"> <?php echo $this -> FG_LIST_ADDING_BUTTON_MSG1?>&nbsp;&nbsp;<img src="<?php echo $this -> FG_LIST_ADDING_BUTTON_IMG1?>" border="0" title="<?php echo $this->FG_LIST_ADDING_BUTTON_ALT1?>" alt="<?php echo $this->FG_LIST_ADDING_BUTTON_ALT1?>"></a>-->
        ...
        <?php if($this->FG_LIST_ADDING_BUTTON2) {?>
          <!--  <a class="btn btn-primary btn-small" href="<?php echo $this -> FG_LIST_ADDING_BUTTON_LINK2    ?>"> <?php echo $this -> FG_LIST_ADDING_BUTTON_MSG2?>&nbsp;&nbsp;<img src="<?php echo $this -> FG_LIST_ADDING_BUTTON_IMG2?>" border="0" title="<?php echo $this->FG_LIST_ADDING_BUTTON_ALT2?>" alt="<?php echo $this->FG_LIST_ADDING_BUTTON_ALT2?>"></a>-->
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" style="width: 99%;
    margin: 0 auto;">
	
	<div class="kt-portlet kt-portlet--mobile" style="padding:5px;">
      ...
      <?php  IF ($this -> CV_DO_ARCHIVE_ALL){ ?>
       ...
       <FORM NAME="theFormFilter">
        ...
        <tr>
          <td class="viewhandler_table2_td3">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td>   <div style="float:left;margin-top:10px;margin-left: 3px;">
                                <b><span class="btn btn-default" style="margin-top:0px;">  <?php echo strtoupper($this->CV_TITLE_TEXT) ?>  - <?php echo $this -> FG_NB_RECORD.' '.gettext("Records"); ?></span></b>
                            </div>
                  </td>
        ...
        <?php if ($this->CV_DISPLAY_RECORD_LIMIT){ ?>
            ...
            <input style="width:55px" class="btn btn-success btn-mini "  value=" <?php echo gettext("GO");?> " type="SUBMIT">
            
        <?php   }   ?>
        <?php if ($this->FG_EXPORT_CSV){ ?>
          <a class="btn btn-success btn-mini " href="export_csv.php?var_export=<?php echo $this->FG_EXPORT_SESSION_VAR ?>&var_export_type=type_csv" target="_blank" ><?php echo gettext("Export CSV");?></a>

        <?php   }   ?>
        <?php if ($this->FG_EXPORT_XML){ ?>
         <a class="btn btn-success btn-mini " href="export_csv.php?var_export=<?php echo $this->FG_EXPORT_SESSION_VAR ?>&var_export_type=type_xml" target="_blank" ><?php echo gettext("Export XML");?></a>
       ...
       <FORM NAME="theFormFilter" action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL);?>">
            ...
            ?>
                <input type="SUBMIT" value="<?php echo gettext("APPLY FILTER ");?>" style="width:110px;"  class="btn btn-success btn-mini "/>
            </span>
            </FORM>
        ...
        ?>
                ...
                for($i=0;$i<$this->FG_NB_TABLE_COL;$i++) {
                    ...
                    <TD vAlign="top" align="<?php echo $this->FG_TABLE_COL[$i][3]?>" style="text-align: left;color: #666;font-size: 0.9rem;"><?php
                       ...
                       <?php if($this->FG_OTHER_BUTTON1)
                                {
                                    ...
                                    <a href="<?php
                                        ...
                                        if (strlen($this -> FG_OTHER_BUTTON1_IMG)==0) {
                                            echo '"'.$extra_html.'> '.'<span class="btn" style="background-color:transparent; border-color:#eeeeee;">'.$this->FG_OTHER_BUTTON1_ALT.'</span>';
                                        } else {                                                                                                         
                                            //<img src=" echo $this -> FG_OTHER_BUTTON1_IMG"  border="0" title=" echo $this->FG_OTHER_BUTTON1_ALT" alt=" echo $this->FG_OTHER_BUTTON1_ALT">
                                            ?>"<?php echo $extra_html ?>> <i class="flaticon-eye <?php echo $this->FG_OTHER_BUTTON1_IMG; ?>" title="<?php echo $this->FG_OTHER_BUTTON1_ALT?>"></i><?php
                                        }
                                        ?></a>
                                <?php }
                                    }
                       ...
                       <?php if($this->FG_OTHER_BUTTON2)
                                {
                                    ...
                                    <a href="<?php
                                        ...
                                        if (strlen($this -> FG_OTHER_BUTTON2_IMG)==0){
                                            echo '"'.$extra_html.'> '.'<span class="btn" style="background-color:transparent; border-color:#eeeeee;">'.$this->FG_OTHER_BUTTON2_ALT.'</span>';
                                        }else{
        ...
        <TR >
          <TD style="PADDING-LEFT: 5px; PADDING-RIGHT: 3px" colspan="2" align="right">
            <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
                <TR>
                  <TD align="right" valign="bottom"><div class="dataTables_paginate paging_simple_numbers" id="kt_table_1_paginate"><ul class="pagination"></ul>
                            <?php
