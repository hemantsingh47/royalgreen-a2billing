...
<div class="col-md-12">
				...
				<tr>
                  <td align="left" class="bgcolor_003">
                    ...
                    <select name="fromstatsday_sday_bis" class="form-control11">
                     ...
                     <select name="fromstatsmonth_sday_bis" class="form-control-1">
                    <?php
                        $year_actual = date("Y");
                        for ($i = $year_actual ; $i >= $year_actual - 10 ; $i--) {
                            if ($year_actual==$i) {
        ...
        ?>
            ...
            <tr>
                ...
                ?>
                    <select NAME="<?php echo $selects[2]?>" size="1" class="form-control-1">
		...
		<div class="col-md-12">
		 ...
		 <div class="modal-footer">
				...
				<input class="btn btn-primary" name="image16"  value=" <?php echo gettext("Search");?>  " type="submit">
				...
				<!--<input type="image"  name="image16" align="top" border="0" src="<?php echo Images_Path_Main;?>/button-search.gif" />-->
                    ...
                    <?php if (isset($_SESSION[$this->FG_FILTER_SEARCH_SESSION_NAME]) && strlen($_SESSION[$this->FG_FILTER_SEARCH_SESSION_NAME])>10 ) { ?>
                        - <a href="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>?cancelsearch=true" class="btn btn-primary"><?php echo gettext("Cancel Search");?></a>&nbsp;
                        <?php if ($this -> FG_FILTER_SEARCH_DELETE_ALL) { ?>
                            - <a href="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>?deleteselected=true" onclick="return confirm('<?php echo "Are you sure to delete ".$this -> FG_NB_RECORD." selected records?";?>');" class="btn btn-primary"><?php echo gettext("Delete All");?></a>
                        <?php } ?>
                    <?php } ?>
