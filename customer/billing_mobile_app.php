...
if(!isset($_REQUEST["pr_login"]) || !isset($_REQUEST["pr_password"]))
{
 ...
 $first_login = sanitize_data($_REQUEST["pr_login"]);
 $password = sanitize_data($_REQUEST["pr_password"]);        
...
<body class="login_page" style="background:url(../customer/templates/default/images/customer.jpg) no-repeat fixed #77D2EF">
<center>
   <div class="login_page_wrapper" style="width:400px;padding-left:0%;">
        <div class="md-card" id="login_card" style="opacity: 1; transform: scale(1);">
             <div class="md-card-content large-padding" id="register_form" style="display: block;">
			  ...
			  <h1 class="full_width_in_card heading_c"><center><b>Mobile Top Up</b></center></h1>
...
<table>
  ...
  <tr>
                <td colspan="2"><center><p><div id="mr_result" style="color: green;">
  ...
  <tr>
    <td colspan="2">
        <form name="getinfoform" action="<?php echo $_SERVER['PHP_SELF']."?pr_login=".$first_login."&pr_password=".$password;?>" method="post">
        <table>
              <tr > 
                    <div class="md-input-wrapper"><label for="country"></label>
                    <td>
                       <select onchange="countrycode(this.value)" class="md-input"  name="mr_country" style="width: 303px">
                        <?php
                ...
                <tr>
				 ...
				 <td>
					 <div class="uk-form-row">
                       <!-- <div class="md-input-wrapper"><label for="phone">Phone <span style="color:red">*</span></label> -->
					<!--	<input class="md-input" type="text" id="phone" onkeypress='validate(event)' name="phone" required><span class="md-input-bar "></span></div>
                    -->
						 <input type="hidden" name="action" id="action" value="msisdn_info"/>
                               <input type="text"  id="mr_phone_prefix" name="mr_phone_prefix" value="<?php if(isset($_POST['mr_phone_prefix'])){echo $prefix; }?>" maxlength="3" readonly="readonly" class="md-input" style="width:40px;background: transparent;border:none;text-align: right;">
                                <input type="text"  autocomplete="off" id="mr_phone_no"  name="mr_phone_no" placeholder="Enter Mobile Number" class="md-input"  onblur="(document.getinfoform.submit())" value="<?php if(isset($_POST['mr_phone_no'])){echo $fno; }?>"> 
							<div id="number_format_example" class="margin_top5" style="padding-top:5px;color:green; font-style:italic;cursor:pointer">
                        Please Click Outside after enter mobile number.
                    </div>
                    </div></td> 
  ...
  <tr>
    <td><?php echo gettext("Operator"); ?></td>
    <td align="left">
        <div class="col-md-9" id="ans1" style="padding: 15px 30px 15px 30px;">
        <?php
  ...
  <tr>
          <td align="left" ><?php echo gettext("Amount");?></td> 
          <td align="left">
           <div class="col-md-9" id="ans">
            <?php
  ...
  <tr>
  <td align="left" ><?php echo gettext("Send Confirmation to recipient");?></td>
  <td align="left"><input type="checkbox" name="sneder_response" id="sneder_response" checked>
  </td>  
  </tr>  
    <tr>
        <td colspan="2">
         <form name="getupdate_characters" method="post" action="<?php echo $_SERVER['PHP_SELF']."?pr_login=".$first_login."&pr_password=".$password ?>">
            <table>
                <tr>
                    <td><?php echo gettext("Selected Amount");?>:</td> 
                    <td class="btn btn-info">
                       
                            <input type="button" class="md-btn md-btn-success" id="amount_value" name="amount_value" value="0" style="border:0px;">
                            <?php
                ...
                <tr>
                    <td></td> 
                    <td>
                    <br><input type="submit" name="btnSubmit" value="<?php echo gettext("Continue");?>" id="btnSubmit" class="md-btn md-btn-primary md-btn-block md-btn-small" onclick="return confirm('Are you sure you want to continue..')" /></td>
