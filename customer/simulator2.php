...
$smarty->display('main.tpl');
    ...
    echo '<h3 class="heading_b uk-margin-bottom">SIMULATOR</h3>';
...
<div class="widget-box">
		...
		<?php echo $error_msg; ?>
          <form NAME="theFormFilter" action="<?php echo $PHP_SELF?>" class="form-horizontal">
            <br/><div class="control-group">
              <label class="control-label">Simulator :</label>
              <div class="controls">
                <input type="text" class="span5" name="called" value="<?php echo $called;?>" placeholder="Enter Simulator" />
              <br>
                <?php if (false) { ?>
                <br>
                <font color="white"><b><?php echo gettext("YOUR BALANCE");?>&nbsp;:</b></font>
                <INPUT type="text" name="balance" value="<?php if (!isset($balance)) echo "10"; else echo $balance;?>" class="span5">
                <?php } ?>
                <br><br>
			  </div>
            </div>
            <div class="form-actions">
			<input type="submit" class="btn btn-primary" value="<?php echo gettext("SEARCH");?>">
			</div>
          </form>
        </div>
      </div>
