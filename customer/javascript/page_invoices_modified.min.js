                ...
                if($invoice_add_btn){
                    var i=function(){
                        ...
                        var o=function(){
                            ...
                            n=i.html(),t=Handlebars.compile(n),o=e.children().length?parseInt(e.children(".uk-grid:last").attr("data-service-number"))+1:1,
                            c={invoice_service_id:o},a=t(c);
                            e.append(a),altair_md.inputs(),
                            altair_forms.textarea_autosize(),
                            altair_uikit.reinitialize_grid_margin()};o(),
                            ...
                            e=function(){
                                ...
                                setTimeout(function(){
                                    altair_uikit.reinitialize_grid_margin()},560)};
                                    $invoice_add_btn.on("click",function(n){n.preventDefault(),altair_md.card_show_hide($invoice_card,i,e,void 0)})}},
                                    open_invoice:function(){
                                        var i=function(i){
                                            var e=i,n=$("#invoice_template"),t=n.html(),
                                            o=Handlebars.compile(t),c=parseInt(e.attr("data-invoice-id")),
                                            a={
                                                invoice:{
                                                    id:c,
                                                    ...
                                                    invoice_payment_due:"14",header:3==c||7==c,footer:3==c||7==c}
                                            },r=o(a);
                                            $invoice_preview.html(r),$invoice_form.html(""),$window.resize(),
                                            setTimeout(function(){
                                                altair_uikit.reinitialize_grid_margin()},290)};
                                        ...
                                        ,print_invoice:function(){
                                            $body.on("click","#invoice_print",function(i){
                                                i.preventDefault(),UIkit.modal.confirm("Do you want to print this invoice?",function(){
                                                    altair_main_sidebar.hide_sidebar(),setTimeout(function(){window.print()},300)},
                                                    {labels:{Ok:"print"}})})},
                                                    copy_list_sidebar:function(){$sidebar_secondary_toggle.addClass("uk-hidden-large");
                                                    var i=$invoices_list_main.clone();i.attr("id","invoices_list_sidebar"),
