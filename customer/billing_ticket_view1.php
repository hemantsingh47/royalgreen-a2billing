...
<table class="epayment_conf_table">
    <tr class="form_head">
        <td ><font color="#FFFFFF"><b><?php echo gettext("TICKET: "); ?></b></font><font color="#FFFFFF"><?php echo $ticket->getTitle();  ?></font></td>
        <td align="center" ><font color="#FFFFFF"><b><?php echo gettext("NUMBER: "); ?> </b></font><font color="Red"> <?php echo $ticket->getId(); ?></font></td>
    </tr>
    <tr>
        <td>
        &nbsp;
