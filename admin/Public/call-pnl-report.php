                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">
                             Other Reports                      </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="call-pnl-report.php?section=5" class="kt-subheader__breadcrumbs-link">
                             PNL Reports               </a>
                                        <!--			
...
<FORM METHOD=POST name="myForm" ACTION="<?php echo $PHP_SELF?>?s=1&t=0&order=<?php echo $order?>&sens=<?php echo $sens?>&current_page=<?php echo $current_page?>" class="kt-form">
    ...
    ?>
        <table class="table" border="0" cellspacing="1" cellpadding="2" align="center">
            <tr>
                <td align="left" class="bgcolor_004" style="vertical-align:top; border:0">
                  ...
                  <td align="left" class="bgcolor_005" style="padding-top:0; border:0">
                    ...
                    <select name="fromstatsday_sday" class="form-control-2" >
                        <?php
                        for ($i=1;$i<=31;$i++) {
                     ...
                     <select name="fromstatsmonth_sday" class="form-control-1">
                    <?php
                    ...
                    <?php echo gettext("To");?>  :&nbsp;&nbsp; &nbsp;  &nbsp;
                    <select name="tostatsday_sday" class="form-control-2" >
                    <?php
                        for ($i=1;$i<=31;$i++) {
                    ...
                    ?>
                     ...
                     <select name="tostatsmonth_sday" class="form-control-1">
            ...
            <tr>
                ...
                <td class="" align="left">
                <select name="lst_time" class="form-control13" style="width: 48%;">
            ...
            <tr>
                                <td class="" align="left"><font class="fontstyle_003">&nbsp;<?php echo gettext("Report Type");?></font></td>
                                <td class="" align="left">
                                <select name="report_type" class="form-control13" style="width: 48%;">
            ...
            <tr>
                ...
                <td class="bgcolor_005" align="right" >
                   <input type="submit"  class="btn btn-small btn-primary"  name="image16" align="top" border="0"
            value="<?php
            echo gettext("Search");
            ?>" /></td>
            </tr>
...
if ($res) {
    ...
    ?><br><br><table cellspacing="0" cellpadding="0" border="0" align="center" width="95%" class="table">
    <tr class="form_head"><th class='tableBody'></th>
    <th class='tableBody'><?php gettext('Total Calls');?></th>
    <th class='tableBody'><?php gettext('Total Min');?></th>
    <th class='tableBody'><?php gettext('Toll Free Cost');?></th>
    <th class='tableBody'><?php gettext('PayPhone Cost');?></th>
    <th class='tableBody'><?php gettext('Origination Cost');?></th>
    <th class='tableBody'><?php gettext('Credits');?></th>
    <th class='tableBody'><?php gettext('Total Cost');?></th>
    <th class='tableBody'><?php gettext('Toll Free Revenue');?></th>
    <th class='tableBody'><?php gettext('Pay Phone Revenue');?></th>
    <th class='tableBody'><?php gettext('Termination Revenue');?></th>
    <th class='tableBody'><?php gettext('Extra Charges');?></th>
    <th class='tableBody'><?php gettext('Total Revenue');?></th>
    <th class='tableBody'><?php gettext('First Use');?></th>
    <th class='tableBody'><?php gettext('Average Discount');?></th>
    <th class='tableBody'><?php gettext('Net Revenue');?></th>
    <th class='tableBody'><?php gettext('Margin');?></th>
    <th class='tableBody'><?php gettext('Total Profit');?></th></tr>
    <?php
    $roa = array();
    $row = $res -> fetchRow();
    echo "<TR>";
    for ($k=0; $k<18; $k++) {
        echo "<Th class='tableBody'>";
         if ($k<3) {
            echo $row[$k];
        } else {
