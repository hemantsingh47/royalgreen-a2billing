...
<HEAD>
	...
	<script type="text/javascript" src="templates/{$SKIN_NAME}/newtheme/theme/classic/assets/js/demo12/jquery.min.js"></script>
	...
	<!-- begin::Global Config(global config for global JS sciprts) -->
		...
		<!--<script src="templates/{$SKIN_NAME}/newtheme/theme/classic/assets/vendors/global/vendors.bundle.js" type="text/javascript"></script>-->
