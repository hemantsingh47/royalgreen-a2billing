        ...
        <div class="kt-grid__item">
          <div class="kt-wizard-v1__nav">
            <div class="kt-wizard-v1__nav-items">
              ...
              <a class="kt-wizard-v1__nav-item" href="#" data-ktwizard-type="step">
                <div class="kt-wizard-v1__nav-body">
                  ...
                  <div class="kt-wizard-v1__nav-label">
                    ...
                    <?php if (!empty($_SESSION['entity_card_selection'])) { ?>&nbsp;(<font style="color:#EE6564;" > <?php echogettext("search activated"); ?> </font> ) <?php } ?> 
                  </div>
                </div>
              </a> 
              <a href="A2B_entity_card_multi.php?stitle=Card&section=<?php echo $_SESSION['menu_section']; ?>"class="kt-wizard-v1__nav-item" data-ktwizard-type="step">
                <div class="kt-wizard-v1__nav-body">
                  <div class="kt-wizard-v1__nav-icon">
              ...
              <a href="A2B_entity_card.php?form_action=ask-add&atmenu=card&stitle=Card&section=<?php echo $_SESSION['menu_section'];?>"class="kt-wizard-v1__nav-item"  data-ktwizard-type="step">
                <div class="kt-wizard-v1__nav-body">
                  <div class="kt-wizard-v1__nav-icon">
                    <i class="flaticon-responsive"></i>
                  </div>
...
?>
    ...
    <h2><?php echo gettext("Add Customer");?></h2>
     <div class="row-fluid">
     <form action="A2B_entity_card.php" method="get" name="cardform" class="form-horizontal">
    <input type="hidden" name="form_action" value="ask-add">
    <input type="hidden" name="section" value="1">
        <div class="control-group">
              <label class="control-label" style="width: 50%;"><?php echo gettext("Change the Account Number Length")?>&nbsp; : &nbsp;</label>
              <div class="controls">
                 <select name="cardnumberlenght_list" size="1" class="input" onChange="submitform()" title="Select your card length">
