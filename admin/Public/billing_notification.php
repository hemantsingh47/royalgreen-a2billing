...
/**
 * This file is part of billingilling (http://www.billingilling.net/)
 *
 * billingilling, Commercial Open Source Telecom Billing platform,
 * powered by Star2billing S.L. <http://www.star2billing.com/>
 *
 * @copyright   Copyright (C) 2004-2015 - Star2billing S.L.
 * @author      Belaid Arezqui <areski@gmail.com>
 * @license     http://www.fsf.org/licensing/licenses/agpl-3.0.html
 * @package     billingilling
 *
...
<table width="90%" style ="margin-left:auto;margin-right:auto;" cellspacing="2" cellpadding="2" border="0">
    ...
    <tr>
        ...
        <?php if ($page>1) { ?>
            <a href="billing_notification.php?page=<?php echo $page-1; ?>"> &lt; <?php echo gettext("Newer") ?> </a>
        <?php } ?>
        &nbsp;
        </td>
        ...
        &nbsp;
                <?php if ($page<$nb_page) { ?>
        <a href="billing_notification.php?page=<?php echo $page+1; ?>"><?php echo gettext("Older") ?> &gt;</a>
                <?php } ?>
        </td>
    </tr>
    <?php } ?>
...
$(document).ready(function () {
    ...
    $('.newrecord').click(function () {
        $.get("billing_notification.php", { id: ""+ this.id, action: "view" },
              function(data){
    ...
    $('#viewall').click(function () {
        $.get("billing_notification.php", { page: ""+ page, action: "viewall", ids : ids },
              function(data){
                if(data=="true") location.reload(true);
              });
        });
    ...
    $('.delete').click(function () {
            if (confirm("<?php echo gettext("Do you want delete this notification ?") ?>")) {
                $.get("billing_notification.php", { id: ""+ this.id, action: "delete" },
                      function(data){
