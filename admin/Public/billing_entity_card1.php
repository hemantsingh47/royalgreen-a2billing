...
?>
<h2><?php echo gettext("Customers");?></h2><hr/>
<!--begin: Datatable -->
...
<p style="display: inline-block;">
        <?php if ( $form_action == "list" && (!($popup_select>=1)) ) { ?>
                ...
                <a href="#"   onclick="toggle_visibility('tohide2')" class="btn btn-label-success btn-bold" onmouseover="this.style.cursor='hand';"><!--<i class="uk-icon-search"></i>-->&nbsp;<?php echo gettext("Batch Update");?> 
			...
			<a href="#" id="" target="_self"  onclick="toggle_visibility('tohide1')" class="btn btn-label-success btn-bold" onmouseover="this.style.cursor='hand';">
             ...
             <?php if (!($popup_select>=1)) { ?>
                            <a href="A2B_entity_card_multi.php?stitle=Card&section=<?php echo $_SESSION['menu_section']; ?>" class="btn btn-label-success btn-bold" onmouseover="this.style.cursor='hand';">
             ...
             <?php }?>
             <?php if (!($popup_select>=1)) { ?>
                            <a href="A2B_entity_card.php?form_action=ask-add&atmenu=card&stitle=Card&section=<?php echo $_SESSION['menu_section'];?>" class="btn btn-label-success btn-bold" onmouseover="this.style.cursor='hand';" >
...
<center><a href="#" target="_self" class="toggle_menu"><img class="toggle_hide2show" src="<?php echo KICON_PATH; ?>/toggle_hide2show.png" onmouseover="this.style.cursor='hand';" HEIGHT="16"> <font class="fontstyle_002"><?php<!--o gettext("SEARCH CUSTOMERS");?> </font></a><?php if (!empty($_SESSION['entity_card_selection'])) { ?>&nbsp;(<font style="color:#EE6564;" > <?php echo gettext("search activated"); ?> </font> ) <?php } ?> </center>
