              ...
              <form name="form" enctype="multipart/form-data" action="billing_signup_agent.php" method="post">
                <tr>
                      <td colspan="2" align=center>
                          ...
                          <select id="selectagent" NAME="agentid" size="1" class="form_input_select">
                           ...
                           <a href="#"
                    onclick="window.open('billing_entity_agent.php?popup_select=1&popup_formname=form&popup_fieldname=agentid' , 'CardNumberSelection','scrollbars=1,width=550,height=330,top=20,left=100,scrollbars=1');"><img
                ...
                <tr>
                 <td  width="50%" align="center">
                        <a class="cssbutton_big"  href="billing_entity_signup_agent.php?section=2">
