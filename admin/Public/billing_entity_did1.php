...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h5 class="kt-portlet__head-title">
           <?php if ($form_action == 'ask-add'){echo gettext("Add DID"); }else if( $form_action == 'ask-delete'){echo gettext("Delete DID");} else if( $form_action == 'ask-edit'){echo gettext("Modify DID");} else{echo gettext("DID List"); }?>
	    </h5>
        </div>
	</div>
<br>
