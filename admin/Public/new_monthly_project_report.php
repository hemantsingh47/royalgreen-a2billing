...
<table width='100%' border="0" cellspacing="10" cellpadding="10">
	...
	<td><a href="logout.php"><h3 align ="right" style="color:#4d0000;">Logout</h3></a>
	<a href="https://billing.adoreinfotech.co.in/monthly_report/userinfo.php"><h3 align ="right" style="color:#4d0000;">Dashboard</h3></a>
	</td>
    ...
    case ($var[id]=='1'):
     ...
     break;
	  ...
	  case ($var[id]=='4'):
	       echo "<tr id= 'h'>";
		    if ($var[id]=='4') {
            $bgColor = ' style="background-color:#ffffff !important;" ';
              }
            echo "<td>";
            echo $var['id'];
            echo "</td>";
