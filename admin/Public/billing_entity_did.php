...
<div class="kt-portlet__head">
	<div class="kt-portlet__head-label">
		<h1 class="kt-portlet__head-title">
			<?php if ($form_action == 'ask-add'){echo gettext("Add DID"); }else if( $form_action == 'ask-delete'){echo gettext("Delete DID");} else if( $form_action == 'ask-edit'){echo gettext("Modify DID");} else{echo gettext("List DID"); }?>
		</h1>
	</div>
</div>
