...
if (empty($id)) {
    header("Location: billing_entity_logrefill.php?atmenu=payment&section=10");
}
                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">
                             Customer Billing                       </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="billing_refill_info.php?id=4" class="kt-subheader__breadcrumbs-link">
                           Refills Info                     </a>
...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h5 class="kt-portlet__head-title">
           <?php echo gettext("Customer's Refill Info"); ?>
	    </h5>
        </div>
	</div>
...
<table style="width : 80%;" class="editform_table1">
 ...
 <div style="width : 80%; text-align : right; margin-left:auto;margin-right:auto;" >
     <a class="btn btn-primary"  href="<?php echo "billing_entity_logrefill.php?atmenu=payment&section=10" ?>">
