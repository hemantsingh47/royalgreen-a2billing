	...
	<div class="kt-portlet__head">
		<div class="kt-portlet__head-label">
			<h1 class="kt-portlet__head-title">
				<?php echo gettext("Daily Traffic"); ?>
	...
	<?php
        ...
        <?php
			...
			<td><INPUT TYPE="text"
					...
					<td width="5%">
               <b>OR</b></td>
               <td align="left"> <?php echo gettext ( "Enter the customer number" );?>:</td>
				<td>
...
<td align="left" >
              <label class=""><?php echo gettext ( "Select Day" ); ?></td>
              <td >
                <input type="checkbox"
			  ...
			  <INPUT TYPE="text" class="form-control" NAME="dst" value="<?php echo $dst?>"></td>
			  ...
			  <tr>
                      <td colspan="5">     <!-- <input type="image"  name="image16" align="top" border="0" src="<?php echo Images_Path;?>/button-search.gif" />-->
