            ...
            Merge RateCards                            </h3>
                ...
                <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        <a href="" class="kt-subheader__breadcrumbs-link">
                         ...
                         <a href="billing_entity_tariffplan.php" class="kt-subheader__breadcrumbs-link">
                            Rate Cards	                        </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="CC_ratecard_merging.php?atmenu=ratecard&section=6" class="kt-subheader__breadcrumbs-link">
                            Merge                       </a>
...
<div class="kt-portlet__head">
	<div class="kt-portlet__head-label">
		<h1 class="kt-portlet__head-title">
			<?php echo gettext("Merge RateCards");?>
		</h1>
	</div>
</div>
<br> 
...
<div align="center">
        <table width="95%" border="0" cellspacing="2" align="center" class="">
              <form name="prefs" action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>" method="post">
                    ...
                    <td width="30%" valign="middle" >
						<div class="form-group form-group-last">
							<label class="col-8 col-form-label" >
								<?php echo gettext("RATECARD SOURCE");?> :
							</label>
						</div>
					</td>
                      <td width="70%" valign="top">
                          <select NAME="ratecard_source" size="1" class="form-control" style="width:250" data-selectize>
                ...
                <tr>
                    <td width="30%" valign="middle" >
						<div class="form-group form-group-last">
							<label class="col-8 col-form-label" >
								<?php echo gettext("RATECARD TO UPDATE");?> :</td>
							</label>
						</div>
					
                      <td width="70%" valign="top" class="">
                          <select NAME="ratecard_destination" size="1" class="form-control" style="width:250" data-selectize>
...
<br>
                <tr>
                    <td width="30%" valign="middle" >
						<div class="form-group form-group-last">
							<label class="col-8 col-form-label" >
								<?php echo gettext("Choose fields to merge");?> :</td>
							</label>
						</div>
                    ...
                    <td width="70%" valign="top" class="">
                        ...
                        <table>
                            <tbody><tr>
                                <td>
                                    <select name="unselected_search_sources" multiple="multiple" class="form-control" size="9" width="50"  onchange="deselectHeaders()" >
                                ...
                                <td>
                                    <select name="selected_search_sources" class="form-control" multiple="multiple" size="9" width="50"  onchange="deselectHeaders();" >
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td align="right">
                    <input class="btn btn-primary" name="submit"  TYPE="submit" VALUE="MERGE"></td>
                </tr>
