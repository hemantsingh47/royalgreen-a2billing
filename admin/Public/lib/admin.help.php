...
$SPOT['PAYPAL'] = '<a href="https://www.paypal.com/en/mrb/pal=PGSJEXAEXKTBU" target="_blank"><img src="' . KICON_PATH . '/paypal_logo.png" alt="Paypal"/></a>';
...
$SPOT['STRIPE'] = '<a href="https://stripe.com/" target="_blank"><img src="'.KICON_PATH.'/stripe.png" alt="Stripe"/></a>';
$SPOT['AUTHORIZENET'] = '';
