...
<FORM action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL) ?>" method="POST" name="myForm" id="myForm" class="kt-form">
...
<?php
    ...
    for ($i=0;$i<$this->FG_NB_TABLE_EDITION;$i++) {
        ...
        if (strlen($this->FG_TABLE_EDITION[$i][16])>1) {
            echo '<TH width="25%" valign="top" colspan="2" class="kt-portlet__head-title" style="text-align:left; font-size:1.5rem; font-weight:500;">';
...
?>
        ...
        <?php if (!$this-> FG_fit_expression[$i]  &&  isset($this-> FG_fit_expression[$i]) ) { ?>
            <TD   class="form_head_red" style="width:40%"> 		<?php echo $this->FG_TABLE_EDITION[$i][0]?> 		</TD>
              <TD valign="top" class="tableBodyRight" style="width:60%">
        <?php } else { ?>
            <TD  class="form_head" style="width:40%"> 		<?php echo $this->FG_TABLE_EDITION[$i][0]?> 		</TD>
            <TD  class="tableBodyRight"  style="width:60%">
        <?php }
            ...
            if ($this->FG_DEBUG == 1) print($this->FG_TABLE_EDITION[$i][3]);
                ...
                ?>
                    <SELECT name='<?php echo $this->FG_TABLE_EDITION[$i][1]?>' class="form-control">
                    <?php
            ...
            ?>
                <INPUT class="form-control" style="width:90%;" name=<?php echo $this->FG_TABLE_EDITION[$i][1]?>  <?php echo $this->FG_TABLE_EDITION[$i][4]?> value="<?php
                    if ($this->VALID_SQL_REG_EXP) {
                        echo stripslashes($list[0][$i]);
                    } else { echo $processed[$this->FG_TABLE_ADITION[$i][1]]; }?>">
                                    <a href="#" onclick="window.open('<?php echo $this->FG_TABLE_EDITION[$i][12]?>popup_formname=myForm&popup_fieldname=<?php echo $this->FG_TABLE_EDITION[$i][1]?>' <?php echo $this->FG_TABLE_EDITION[$i][13]?>);"><i class="flaticon2-fast-next"></i></a>
             <?php
                } elseif (strtoupper ($this -> FG_TABLE_EDITION[$i][3])=="POPUPVALUETIME") {
                        ?>
                        <INPUT class="form-control" style="width:90%;" name=<?php echo $this->FG_TABLE_EDITION[$i][1]?>  <?php echo $this->FG_TABLE_EDITION[$i][4]?> value="<?php if ($this->VALID_SQL_REG_EXP) { echo stripslashes($list[0][$i]); } else { echo $processed[$this->FG_TABLE_ADITION[$i][1]]; }?>">
                         <a href="#" onclick="window.open('<?php echo $this->FG_TABLE_EDITION[$i][14]?>formname=myForm&fieldname=<?php echo $this->FG_TABLE_EDITION[$i][1]?>' <?php echo $this->FG_TABLE_EDITION[$i][14]?>);"><i class="flaticon2-fast-next"></i></a>
                        <?php
                } elseif (strtoupper ($this->FG_TABLE_EDITION[$i][3])=="POPUPDATETIME") {
                        ?>
                         <INPUT class="form-control" name=<?php echo $this->FG_TABLE_EDITION[$i][1]?>  <?php echo $this->FG_TABLE_EDITION[$i][4]?> value="<?php if ($this->VALID_SQL_REG_EXP) { echo stripslashes($list[0][$i]); } else { echo $processed[$this->FG_TABLE_ADITION[$i][1]]; }?>">
              ...
              ?>
                    ...
                    if (strtoupper ($this->FG_TABLE_EDITION[$i][7])=="SQL") {
                     ...
                     if ($this->FG_DEBUG >= 2) echo "<br><br>::>".$this->FG_TABLE_ADITION[$i][1];
                       ?>
                        <SELECT name='<?php echo $this->FG_TABLE_EDITION[$i][1]?><?php if (strpos($this->FG_TABLE_EDITION[$i][4], "multiple")) echo "[]";?>' class="form-control" <?php echo $this->FG_TABLE_EDITION[$i][4]?>>
                        <?php
            ...
            <?php
                              ...
                              <TR>
                                ...
                                ?>
                                  ...
                                  <TR class="" bgcolor="<?php echo $this->FG_TABLE_ALTERNATE_ROW_COLOR[$j%2]?>"  onMouseOver="bgColor='#C4FFD7'" onMouseOut="bgColor='<?php echo $this->FG_TABLE_ALTERNATE_ROW_COLOR[$j%2]?>'">
                                    <TD vAlign=top class=tableBody style="width:40%">
                                    ...
                                    <TD align="center" vAlign=top class=tableBodyRight style="width:60%">
                                      							  
									  
									 <input onClick="sendto('del-content','<?php echo $i?>','<?php echo $table_split[1]?>_hidden','<?php echo $split_select_list[$j][1]?>');" title="Remove this <?php echo $this->FG_TABLE_EDITION[$i][0]?>" alt="Remove this <?php echo $this->FG_TABLE_EDITION[$i][0]?>"  id=submit33 name=submit33 type=button  value="add-split" class="btn btn-primary">
                                    </TD>
                                  </TR>
                                  <?php
                    ...
                    <TR>
                      ...
                      <TD align="center" valign="top"  class="text"><br>
                        <TABLE  height=50 border=0 align="center" cellPadding=0 cellSpacing=0>
                            <TR>
                                <TD colspan=3 height=16 style="PADDING-LEFT: 5px; PADDING-RIGHT: 5px" class="form_head">
                                    <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
                                        <TR>
                                ...
                                <TABLE width="97%" border=0 align="center" cellPadding=0 cellSpacing=0>
                                    <TR>
                                        ...
                                        <TD width="516"><div align="center">
                                          ...
                                          <SELECT name="<?php echo $table_split[1]?>[]" <?php echo $this->FG_TABLE_EDITION[$i][4]?> class="form-control">
                                            <?php
                                    ...
                                    <TR>
                                        <TD colspan="2" align="center" vAlign="middle">
                                            ...
                                            <span class="btn btn-primary"> <i class="fa flaticon-add"></i> ADD <?php echo $this->FG_TABLE_EDITION[$i][0]?></span></a>
                                        </TD>
                                    </TR>
                                </TABLE>
                            </TD>
                        ...
                        <table cellspacing="0" class="editform_table2">
                          ...
                          <TR>
                            <TD>
                                ...
                                ?>
                                  <TR bgcolor="<?php echo $this->FG_TABLE_ALTERNATE_ROW_COLOR[$j%2]?>"  onMouseOver="bgColor='#C4FFD7'" onMouseOut="bgColor='<?php echo $this->FG_TABLE_ALTERNATE_ROW_COLOR[$j%2]?>'">
                                    <TD vAlign="top" align="<?php echo $this->FG_TABLE_COL[$i][3]?>" class="tableBody" style="width:40%;">
                                      <font face="Verdana" size="2">
                                      <?php if (!empty($split_select_list[$j][$table_split[7]])) {
                                      ?>
                                      <b><?php echo $split_select_list[$j][$table_split[7]]?></b> :
                                    ...
                                    <TD align="center" vAlign="top2" class="tableBodyRight" style="width:60%;">
                                      <input onClick="sendto('del-content','<?php echo $i?>','<?php echo $table_split[1]?>','<?php echo $split_select_list[$j][1]?>');" alt="Remove this <?php echo $this->FG_TABLE_EDITION[$i][0]?>" border=0 height=11 hspace=2 id=submit33 name=submit33  type=button width=33 value="add-split" class="btn btn-primary">
                                    </TD>
                                  </TR>
                                <?php
                                }//end_for
                                ...
                                <TABLE width="97%" border=0 align="center" cellPadding=0 cellSpacing=0>
                                    <TR>
                                        ...
                                        <?php if ($this->FG_TABLE_EDITION[$i][4] == "multiline") {?>
                                              <textarea name=<?php echo $table_split[1]?> class="form-control"  cols="40" rows="5"></textarea>
                                        <?php } else {?>
                                            <INPUT TYPE="TEXT" name=<?php echo $table_split[1]?> class="form-control"  size="20" maxlength="20">
                                        <?php }?>
                                        </TD>
                                    </TR>
                                    <TR>
                    ...
                    <TR>
                      <!-- ******************** PARTIE EXTERN : HAS_MANY ***************** -->
                         <!-- <TD width="122" class="form_head"><?php echo $this->FG_TABLE_EDITION[$i][0]?></TD>-->
                          <TD align="center" valign="top"  class="text" colspan="2" style="padding:0rem"> 
                        <!-- Table with list instance already inserted -->
                        <table cellspacing="0" class="table" align="left">
                          <TR bgcolor="#ffffff">
                            ...
                            <TD>
                                ...
                                ?>
                                  <TR bgcolor="<?php echo $this->FG_TABLE_ALTERNATE_ROW_COLOR[$j%2]?>"  onMouseOver="bgColor='#C4FFD7'" onMouseOut="bgColor='<?php echo $this->FG_TABLE_ALTERNATE_ROW_COLOR[$j%2]?>'">
                                    ...
                                    <TD align="right" vAlign="top2" class="tableBodyRight" style="width:60%;">
                                      
									  <button onClick="sendto('del-content','<?php echo $i?>','<?php echo $table_col[0]?>','<?php echo $split_select_list[$j][0]?>');" alt="Remove this <?php echo $this->FG_TABLE_EDITION[$i][0]?>" type="button" class="btn btn-dark" style="background:#db1430; border-color:#db1430;" value="add-split" id="del" name="del"><i class="fa flaticon-delete"></i> Delete</button>
                    ...
                    <TR>
                      ...
                      <TD align="center" valign="top"  class="text" colspan="2" style="padding:0rem">
                        <TABLE  class="table" border=0 align="center" cellPadding=0 cellSpacing=0>
                            <TR>
                                <TD  colspan=3 height=16  class="form_head">
                                    <TABLE border=0 cellPadding=0 cellSpacing=0 width="100%">
                                        <TR>
                                            <TD class="form_head"><b><?php echo gettext("Add a new");?> <?php echo $this->FG_TABLE_EDITION[$i][0]?></b></TD>
                                        </TR>
                                    </TABLE>
                                </TD>
                            </TR>
                            ...
                            <TR>
                                ...
                                <TD class="editform_table4_td1" colspan="2">

                                <TABLE width="100%" border=0 align="center" cellPadding=0 cellSpacing=0 class="table">
                                    <TR>
                                        <TD  class="form_head" style="width:40%;"><?php echo $this->FG_TABLE_EDITION[$i][0]?></TD>
                                        <TD class="tableBodyRight" align="right" style="width:60%;"> 
                                        <?php if ($this->FG_TABLE_EDITION[$i][4] == "multiline") {?>
                                              <textarea name=<?php echo $table_col[0]?> class="form-control"  cols="40" rows="5" style="width:100%!important;"></textarea>
                                        <?php } else {?>
                                            <INPUT TYPE="TEXT" name=<?php echo $table_col[0]?> class="form-control"  size="20" maxlength="20">
                                        <?php }?>
                                        </TD>
                                    </TR>
                                    <TR>
                                        <TD colspan="2" align="right">
                                            <a href="#" onClick="sendto('add-content','<?php echo $i; ?>');"> <span class="btn btn-primary"> <i class="fa flaticon-add"></i> ADD <?php echo $this->FG_TABLE_EDITION[$i][0]?></span></a>
                                        </TD>
                                    </TR>
...
<?php }// END_FOREACH?>
      ...
      <TABLE cellspacing="0" class="table">
        <tr>
            ...
            <td align="right" valign="top" class="text"> <!--<span class="tableBodyRight"><?php echo $this->FG_BUTTON_EDITION_BOTTOM_TEXT?></span> -->
                <input value=" <?php echo $this->FG_EDIT_PAGE_CONFIRM_BUTTON; ?> " class="btn btn-primary" type="SUBMIT">
            </td>
        </tr>
      </TABLE>
</FORM>
