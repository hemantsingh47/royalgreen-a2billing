                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">
                            Packages Offer                     </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="billing_detail_package.php?section=12" class="kt-subheader__breadcrumbs-link">
                            Details                </a>
...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h5 class="kt-portlet__head-title">
           <?php echo gettext("Package Details"); ?>
        ...
        <table border="0" cellspacing="1" cellpadding="2"  class="table">
            ...
            <tr>
                <td align="left" valign="top" class="bgcolor_004" style="border:0">
                   <label class="">
						<?php echo gettext("Enter the card ID");?>: </label>
                </td>
                <td class="bgcolor_005" align="left" style="border:0">
                
                    
                      
						<INPUT TYPE="text" NAME="enter_cardid" value="<?php echo $enter_cardid?>" class="form-control13" style="    width: 66%;">
                        <a href="#" onclick="window.open('billing_entity_card.php?popup_select=1&popup_formname=myForm&popup_fieldname=enter_cardid' , 'CardNumberSelection','width=550,height=330,top=20,left=100,scrollbars=1');"><i class="flaticon2-fast-next"></i>	</a>
                    </td>
            ...
            <tr>
                <td align="left" valign="top" class="bgcolor_004">
                    <label class="col-form-label"><?php echo gettext("PACKAGE");?></label>
                </td>
                <td class="bgcolor_005" align="left">
                
                        <select NAME="enter_packageid" size="1" class="form-control13" style="width:66%">
            ...
            <tr>
                <td class="bgcolor_004" align="left" colspan="2">
				
				<table class="table"><tr><td style="width:25%; padding-left:0px; border-top:0;">

                    <input type="radio" name="Period" value="Month" <?php  if (($Period=="Month") || !isset($Period)) { ?>checked="checked" <?php  } ?>>
                    <label class=""><?php echo gettext("Selection of the month");?></label>
                </td>
                  <td class="bgcolor_004" align="left" style="border-top:0;">
                    ...
                    <?php echo gettext("From");?> : <select name="fromstatsmonth" class="form-control" style="width:80%;">
                    <?php
                    ...
                    To : <select name="tostatsmonth" class="form-control" style="width:85%;">
            ...
            <tr>
                <td align="left" class="bgcolor_004" style="width: 25%;">
                    <input type="radio" name="Period" value="Day" <?php  if ($Period=="Day") { ?>checked="checked" <?php  } ?>>
                    <label class="col-form-label"><?php echo gettext("Selection of the day");?></label>
                </td>
                  <td align="left" class="bgcolor_005">
                    ...
                    <select name="fromstatsday_sday" class="form-control11">
                     ...
                     <select name="fromstatsmonth_sday" class="form-control13" style="width:55%">
                    <?php 	$year_actual = date("Y");
                        for ($i=$year_actual;$i >= $year_actual-1;$i--) {
                            if ($year_actual==$i) {
                                $monthnumber = date("n")-1; // Month number without lead 0.
                    ...
                    ?>
                     ...
                     <select name="tostatsmonth_sday" class="form-control13" style="width:55%">
                    <?php 	$year_actual = date("Y");
                        for ($i=$year_actual;$i >= $year_actual-1;$i--) {
                            if ($year_actual==$i) {
                                $monthnumber = date("n")-1; // Month number without lead 0.
