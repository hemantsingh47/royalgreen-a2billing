                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">
                             Customer History                        </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="card-history.php?atmenu=cardhistory&section=1" class="kt-subheader__breadcrumbs-link">
                            Card History                       </a>
...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h3 class="kt-portlet__head-title">
           <span class="icon"> <i class="flaticon-list-2"></i> </span> <?php echo gettext("Card History");?>
	    </h3>
        </div>
	</div>
    ...
    <div class="kt-portlet__body">      
        ...
        <form METHOD=POST name="myForm" ACTION="<?php echo $PHP_SELF?>?s=1&t=0&order=<?php echo $order?>&sens=<?php echo $sens?>&current_page=<?php echo $current_page?>&terminatecauseid=<?php echo $terminatecauseid?>" class="kt-form">
			...
			<div class="form-group row" width="50px;">
				<label class="col-12 col-form-label"><b><?php echo gettext("CUSTOMER");?>  :</b>
					<?php echo gettext("Enter the customer ID  : ");?>  &nbsp;&nbsp;&nbsp;</label>
						<div class="col-4 col-form-label" >
							...
							<div class="input-group-prepend" style="   float: left; width: 50px;">
								<button class="btn btn-secondary" type="button" style="padding: 0.6rem 1rem" ><i class ="flaticon2-next" ></i></button>
							</div>
							</a>
							<input TYPE="text" NAME="entercustomer" value="<?php echo $entercustomer?>" class="form-control" style="   float: left; width: 80%;"/>
							

						</div>
			</div>
            <div class="form-group row">
				<label class="col-12 col-form-label"><?php echo gettext("DATE");?> :</label>
				<div class="form-group row">
					<div class="kt-checkbox-inline">
					<label class="kt-checkbox" style=" margin-left=5px;">
						<input type="checkbox" name="fromday" value="true" 
							<?php  
								if($fromday) 
								{ 
							?>checked<?php }?>> 
						
							<label class="col-12 col-form-label"><?php echo gettext("FROM : ");?> </label>
							<span></span>
					</label>
					</div>
					<select name="fromstatsday_sday" class="form-control-1">
						<?php
							for ($i=1;$i<=31;$i++) 
							{
					 ...
					 <select name="fromstatsmonth_sday" class="form-control-2">
						<?php
			...
			<div class="form-group row">
				<div class="kt-checkbox-inline">
					<label class="kt-checkbox" style=" padding-left=5px;">
					<input type="checkbox" name="today" value="true" <?php  if ($today) { ?>checked<?php }?>> 
					<label class="col-12 col-form-label"><?php echo gettext("TO : ");?>  </label>
					<span></span>
					</label>
				</div>
					<select name="tostatsday_sday" class="form-control-1">
						<?php
							for ($i=1;$i<=31;$i++) 
							{
					...
					<select name="tostatsmonth_sday" class="form-control-2">
			...
			<!-- this one end-->
			<div class="col-10">
				<input class="btn btn-success" value=" <?php echo gettext("Search");?> " type="submit">
		</div>
	</div>
</div>
		</form>
