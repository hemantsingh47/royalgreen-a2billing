...
/**************************************************************** BATCH UPDATE *****************************************************/
				...
				<div class="kt-portlet" id="myDIV"  style="display:none;">
					...
					<div class="kt-widget1__item"> 
						<span class="icon"> <i class="flaticon-list-2"></i> </span>
						<h5>
							<?php echo gettext("Batch Update");?> <b>&nbsp;<?php echo $HD_Form -> FG_NB_RECORD ?></b> <?php echo gettext("cards selected!"); ?>
							&nbsp;
					...
					<div class="kt-widget1__item">
						<form name="updateForm" action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>" method="post" class="kt-form">
							...
							<div class="form-group">
								...
								<div class="form-group">
									<input class="input " name="upd_description"  size="20" maxlength="20"  value="<?php if (isset($upd_description)) echo $upd_description;?>">
									<br/>
							...
							<div class="form-group">
								...
								<div class="form-group">
									<input class="input "  name="upd_expirationdate" size="20" maxlength="30" <?php echo $comp_date_plus; ?>> 
									<font class="version">
