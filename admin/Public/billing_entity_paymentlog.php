                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">
                             Customer Billing                       </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="billing_entity_paymentlog.php?section=10" class="kt-subheader__breadcrumbs-link">
                            E-Payment Log List                   </a>
...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h5 class="kt-portlet__head-title">
           <?php echo gettext("EPayment Log List"); ?>
	    </h5>
        </div>
	</div>
...
<FORM METHOD=POST name="myForm" ACTION="<?php echo $PHP_SELF?>?s=1&t=0&order=<?php echo $order?>&sens=<?php echo $sens?>&current_page=<?php echo $current_page?>">
    ...
    <INPUT TYPE="hidden" NAME="current_page" value=0>
        <table  width="85%" border="0" cellspacing="1" cellpadding="2" class="table">
            <tbody>
            <tr>
            ...
            <tr>
                ...
                <td class="bgcolor_005" align="right">
                    <input type='submit' name='image16' value='Search' class='btn btn-primary btn-small'>
