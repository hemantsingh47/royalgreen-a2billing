				...
				<tbody>
					<FORM name="updateForm" action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>" method="post" class="kt-form">
						...
						<tr>
							<td align="left"  class="bgcolor_001">
								...
								<span class="icheck-inline">
									<input name="check[upd_id_trunk]" type="checkbox" data-icheck="" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" <?php if ($check["upd_id_trunk"]=="on") echo "checked"?>>
						...
						<tr>
							<td align="left"  class="bgcolor_001">
								<label class="kt-checkbox kt-checkbox--bold">
									<span class="icheck-inline">
									<input name="check[upd_idtariffplan]" type="checkbox" data-icheck="" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"  <?php if ($check["upd_idtariffplan"]=="on") echo "checked"?> >
						...
						<tr>
							<td align="left"  class="bgcolor_001">
								<label class="kt-checkbox kt-checkbox--bold">
									<span class="icheck-inline">
									<input name="check[upd_id_outbound_cidgroup]" type="checkbox" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" <?php if ($check["upd_id_outbound_cidgroup"]=="on") echo "checked"?> >
						...
						<tr>
							...
							<td align="left" class="bgcolor_001">
								<label class="kt-checkbox kt-checkbox--bold">
									<span class="icheck-inline">
										<input name="check[<?php echo $value;?>]" type="checkbox" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" <?php if ($check[$value]=="on") echo "checked"?>>
									...
									<font class="version">
										<div class="kt-radio-inline">
											<label class="kt-radio">
												<input name="radio2" type="radio"style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" NAME="type[<?php echo $value;?>]" value="1" <?php if ((!isset($type[$value]))|| ($type[$value]==1) ) {?>checked<?php }?>> <?php echo gettext("Equal");?>
												<span></span>
											</label>
											
											<label class="kt-radio">
												<input name="radio2" type="radio" data-icheck="" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" NAME="type[<?php echo $value;?>]" value="2" <?php if ($type[$value]==2) {?>checked<?php }?>> <?php echo gettext("Add");?>
												<span></span>
											</label>
											<label class="kt-radio">
												<input name="radio2" type="radio" data-icheck="" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);" NAME="type[<?php echo $value;?>]" value="3" <?php if ($type[$value]==3) {?>checked<?php }?>> <?php echo gettext("Subtract");?>
												<span></span>
											</label>
										</div>
									</font>
					...
					<tr>
						<td align="left"  class="bgcolor_001">
							<label class="kt-checkbox kt-checkbox--bold">
								<span class="icheck-inline">
								<input name="check[upd_tag]" type="checkbox" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; border: 0px; opacity: 0; background: rgb(255, 255, 255);"  <?php if ($check["upd_tag"]=="on") echo "checked"?>>
						...
						<td align="left"  class="bgcolor_001">
							<div class="form-group form-group-last">
								<label class="col-12 col-form-label">16) <?php echo gettext("TAG");?> :</label>
