...
?>
    ...
    ?>
     ...
     <?php echo gettext("Number of customers to create")?> :</label>
							<div class="controls" style="width:75%; padding:10px;">
							<input class="form-control" name="nb_to_create" size="5" maxlength="5" value="<?php echo $nb_to_create; ?>" >
    ...
    <?php } ?>
						...
						<div class="form-group">
              <label class="control-label-ag"><strong>17)</strong>
            <?php echo gettext("Serie");?> :</label>
              <div class="controls" style="width:75%; padding:10px;">
                <select NAME="id_seria" size="1" class="form-control">
			...
			<div class="form-group">
              <label class="control-label-ag"><strong>18)</strong>
            <?php echo gettext("DID GROUP");?> :</label>
              <div class="controls" style="width:75%; padding:10px;">
			  <select NAME="id_didgroup" size="1" class="form-control">
			...
			<div class="form-group">
              <label class="control-label-ag"><strong>19)</strong>
            <?php echo gettext("VAT");?> :</label>
              <div class="controls" style="width:75%; padding:10px;">
                <input name="vat" size="10" style ="width: 367px;" maxlength="10" <?php if(!empty($vat)) echo "value='$vat'"; ?> class="form-control" >
			  </div>
            </div>
			<div class="form-group">
              <label class="control-label-ag"><strong>20)</strong>
            <?php echo gettext("COUNTRY");?> :</label>
              <div class="controls" style="width:75%; padding:10px;">
            <select NAME="id_country" size="1" class="form-control">
