...
<!-- ** ** ** ** ** Part for the research - ** ** ** ** ** -->
   <div class="kt-portlet">
        ...
        <table class="kt-portlet kt-portlet--solid-brand kt-portlet--height-fluid" width="100%">
        ...
        <?php if ($this -> FG_FILTER_SEARCH_1_TIME) { ?>
            <tr>
                <td align="left" class="kt-portlet__foot kt-portlet__foot--sm">
        ...
        ?>
            <tr>
                <td class="kt-portlet__foot kt-portlet__foot--sm" align="left">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="fontstyle_searchoptions">
									&nbsp;&nbsp;
									<INPUT TYPE="text" NAME="<?php echo $two_compare[3]?>"  value="<?php echo $processed[$two_compare[3]]?>" class="md-input">
								</td>
								<input type="radio" name="<?php echo $two_compare[4]?>" value="4" <?php if ($processed[$two_compare[4]]==4) {?>checked<?php }?> data-md-icheck />
								</td>
								<td class="fontstyle_searchoptions" align="center" >
									<input type="radio" name="<?php echo $two_compare[4]?>" value="5" <?php if ($processed[$two_compare[4]]==5) {?>checked<?php }?> data-md-icheck />
								</td>
								<td class="fontstyle_searchoptions" align="center">
									<input type="radio" name="<?php echo $two_compare[4]?>" value="2" <?php if ($processed[$two_compare[4]]==1) {?>checked<?php }?> data-md-icheck />
								</td>
								<td class="fontstyle_searchoptions" align="center" >
									<input type="radio" NAME="<?php echo $two_compare[2]?>" value="2" <?php if ($processed[$two_compare[2]]==2) {?>checked<?php }?>>&lt; =
								</td>
								<td class="fontstyle_searchoptions" align="center" >
									<input type="radio" NAME="<?php echo $two_compare[2]?>" value="3" <?php if ($processed[$two_compare[2]]==3) {?>checked<?php }?>>&lt;
								</td>
								<td width="5%" class="fontstyle_searchoptions" align="center" >
								</td>

								<td>&nbsp;&nbsp;
									<INPUT TYPE="text" NAME="<?php echo $two_compare[3]?>" size="10" value="<?php echo $processed[$two_compare[3]]?>" class="form_input_text">
								</td>
								<td class="fontstyle_searchoptions" align="center">
								...
								<td class="fontstyle_searchoptions" align="center" >
									<input type="radio" NAME="<?php echo $two_compare[4]?>" value="2" <?php if ($processed[$two_compare[4]]==1) {?>checked<?php }?>>&lt; =
								</td>
								<td class="fontstyle_searchoptions" align="center" >
									<input type="radio" NAME="<?php echo $two_compare[4]?>" value="3" <?php if ($processed[$two_compare[4]]==3) {?>checked<?php }?>>&lt;
								</td>
							</tr>
						</table>
					</td>
            ...
            <tr>
                ...
                ?>
                    <select NAME="<?php echo $selects[2]?>" size="1" class="form-control11">
