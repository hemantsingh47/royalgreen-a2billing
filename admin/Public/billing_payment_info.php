...
if (empty($id)) {
    header("Location: billing_entity_payment.php?atmenu=payment&section=10");
}
                ...
                <div class="kt-subheader__breadcrumbs">
                    <a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link">
                             Customer Billing                       </a>
							  <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="billing_payment_info.php?id=3" class="kt-subheader__breadcrumbs-link">
                           Payments Info                     </a>
...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h5 class="kt-portlet__head-title">
           <?php echo gettext("Customer's Payment Info"); ?>
	    </h5>
        </div>
	</div>
...
<table style="width : 80%;" class="editform_table1">
   ...
   <tr height="20px">
       ...
       <tr height="20px">
        ...
        <td>
            <p class="form-control-static">
			<a href="billing_entity_logrefill.php"> <img src="<?php echo Images_Path."/link.png"?>" border="0" title="<?php echo gettext("Link to the refill")?>" alt="<?php echo  gettext("Link to the refill")?>"></a>
		</p>
 ...
 <div style="width : 80%; text-align : right; margin-left:auto;margin-right:auto;" >
     <a class="btn btn-primary"  href="<?php echo "billing_entity_payment.php?atmenu=payment&section=10" ?>">
