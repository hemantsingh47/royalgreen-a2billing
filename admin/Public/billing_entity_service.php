...
<div class="kt-portlet">
	<div class="kt-portlet__head">
		...
		<h5 class="kt-portlet__head-title">
           <?php if ($form_action == 'ask-add'){echo gettext("Add Account Services "); }else if( $form_action == 'ask-delete'){echo gettext("Delete Account Services");} else if( $form_action == 'ask-edit'){echo gettext("Modify Account Services");} else{echo gettext("Account Services List"); }?>
