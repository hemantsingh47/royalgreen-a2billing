<?php
/* ************************************************Code for links STARTS ************************************************************* */
function getlinksforline($accuiredlinks)
{
    $links = array(
    0 =>array( 0 => "dashboard.php", 1 => "DASHBOARD"),
    1 =>array( 0 => "billing_entity_card.php?section=1", 1 => "User#Customer#Add | Search"),
    2 =>array( 0 => "CC_card_import.php?section=1", 1 => "User#Customer#Import"),
    3 =>array( 0 => "billing_entity_friend.php?atmenu=sip&section=1", 1 => "User#Customer#VoIP Settings"),
    4 =>array( 0 => "billing_entity_callerid.php?atmenu=callerid&section=1", 1 => "User#Customer#Caller-ID"),
    5 =>array( 0 => "billing_notifications.php?section=1", 1 => "User#Customer#Credit Notification"),
    6 =>array( 0 => "billing_entity_card_group.php?section=1", 1 => "User#Customer#Groups"),
    7 =>array( 0 => "billing_entity_card_seria.php?section=1", 1 => "User#Customer#Card series"),
    8 =>array( 0 => "billing_entity_speeddial.php?atmenu=speeddial&section=1", 1 => "User#Customer#Speed Dial"),
    9 =>array( 0 => "card-history.php?atmenu=cardhistory&section=1", 1 => "History"),
    10 =>array( 0 => "billing_entity_statuslog.php?atmenu=statuslog&section=1", 1 => "Status"),
    11 =>array( 0 => "billing_entity_agent.php?atmenu=user&section=2", 1 => "User#Agents#Add :: Search"),
    12 =>array( 0 => "billing_entity_signup_agent.php?atmenu=user&section=2", 1 => "User#Agents#Signup URLs"),
    13 =>array( 0 => "billing_entity_user.php?atmenu=user&groupID=0&section=3", 1 => "User#Admins#Add :: Search"),
    14 =>array( 0 => "billing_entity_user.php?atmenu=user&groupID=1&section=3", 1 => "User#Admins#Access Control"),
    15 =>array( 0 => "billing_entity_tariffgroup.php?atmenu=tariffgroup&section=6", 1 => "Rates#Call Plan"),
    16 =>array( 0 => "billing_entity_tariffplan.php?form_action=ask-add&atmenu=tariffplan&section=6", 1 => "Rates#RateCards#Add RateCard"),
    17 =>array( 0 => "billing_entity_tariffplan.php?atmenu=tariffplan&section=6", 1 => "Rates#RateCards#List RateCard"),
    18 =>array( 0 => "CC_ratecard_merging.php?atmenu=ratecard&section=6", 1 => "Rates#RateCards#Merge"),
    19 =>array( 0 => "CC_entity_sim_ratecard.php?atmenu=ratecard&section=6", 1 => "Rates#RateCards#Simulator"),
    20 =>array( 0 => "billing_entity_def_ratecard.php?form_action=ask-add&atmenu=ratecard&section=6", 1 => "Rates#Rate#Add Rate"),
    21 =>array( 0 => "billing_entity_def_ratecard.php?atmenu=ratecard&section=6", 1 => "Rates#Rate#List Rate"),
    22 =>array( 0 => "CC_ratecard_import.php?atmenu=ratecard&section=6", 1 => "Rates#Rate#Import"),
    23 =>array( 0 => "billing_entity_smsrate_show.php?atmenu=tariffgroup&section=6", 1 => "Rates#SMS Rates#List SMS Rate"),
    24 =>array( 0 => "SmsRateImport.php?atmenu=tariffgroup&section=6", 1 => "Rates#SMS Rates#Import SMS Rate"),
    25 =>array( 0 => "billing_entity_webrate_show.php?atmenu=tariffgroup&section=6", 1 => "Rates#Website Rates#List Website Rate"),
    26 =>array( 0 => "WebRateImport.php?atmenu=tariffgroup&section=6", 1 => "Rates#Website Rates#Import Website Rate"),
    27 =>array( 0 => "billing_did.php?section=8", 1 => "DID#DID Calling Card"),
    28 =>array( 0 => "billing_entity_did.php?section=8", 1 => "DID#Add :: Search"),
    29 =>array( 0 => "billing_entity_didgroup.php?section=8", 1 => "DID#Groups"),
    30 =>array( 0 => "billing_entity_did_destination.php?section=8", 1 => "DID#Destination"),
    31 =>array( 0 => "billing_entity_did_import.php?section=8", 1 => "DID#Import [CSV]"),
    32 =>array( 0 => "billing_entity_didx.php?section=8", 1 => "DID#Import [DIDX]"),
    33 =>array( 0 => "billing_entity_did_use.php?atmenu=did_use&section=8", 1 => "DID#Usage"),
    34 =>array( 0 => "billing_entity_did_billing.php?atmenu=did_billing&section=8", 1 => "DID#Billing"),
    35 =>array( 0 => "DIDWW_board.php?section=8", 1 => "DID#DIDWW"),
    36 =>array( 0 => "billing_custom_did.php?section=8", 1 => "DID#Custom DID"),
    37 =>array( 0 => "billing_entity_outbound_cid.php?atmenu=cid&section=9", 1 => "OUTBOUND CID#Add"),
    38 =>array( 0 => "billing_entity_outbound_cidgroup.php?atmenu=cidgroup&section=9", 1 => "OUTBOUND CID#Groups"),
    39 =>array( 0 => "billing_entity_moneysituation.php?atmenu=moneysituation&section=10", 1 => "Billing#Customer Billing#Customers Balance"),
    40 =>array( 0 => "billing_entity_transactions.php?atmenu=payment&section=10", 1 => "Billing#Customer Billing#Transactions"),
    41 =>array( 0 => "billing_entity_billing_customer.php?atmenu=payment&section=10", 1 => "Billing#Customer Billing#Billings"),
    42 =>array( 0 => "billing_entity_logrefill.php?atmenu=payment&section=10", 1 => "Billing#Customer Billing#Refills"),
    43 =>array( 0 => "billing_entity_payment.php?atmenu=payment&section=10", 1 => "Billing#Customer Billing#Payments"),
    44 =>array( 0 => "billing_entity_paymentlog.php?section=10", 1 => "Billing#Customer Billing#E-Payment Log"),
    45 =>array( 0 => "billing_otp.php", 1 => "Billing#Customer Billing#Customer OTP"),
    46 =>array( 0 => "billing_entity_charge.php?section=10", 1 => "Billing#Customer Billing#Charges"),        
    47 =>array( 0 => "billing_entity_agentsituation.php?atmenu=agentsituation&section=10", 1 => "Billing#Agent Billing#Agents Balance"),
    48 =>array( 0 => "billing_entity_commission_agent.php?atmenu=payment&section=10", 1 => "Billing#Agent Billing#Commissions"),
    49 =>array( 0 => "billing_entity_remittance_request.php?atmenu=payment&section=10", 1 => "Billing#Agent Billing#Remittance Request"),
    50 =>array( 0 => "billing_entity_transactions_agent.php?atmenu=payment&section=10", 1 => "Billing#Agent Billing#Transactions"),
    51 =>array( 0 => "billing_entity_logrefill_agent.php?atmenu=payment&section=10", 1 => "Billing#Agent Billing#Refills"),
    52 =>array( 0 => "billing_entity_payment_agent.php?atmenu=payment&section=10", 1 => "Billing#Agent Billing#Payments"),
    53 =>array( 0 => "billing_entity_paymentlog_agent.php?section=10", 1 => "Billing#Agent Billing#E-Payment Log"),        
    54 =>array( 0 => "billing_entity_receipt.php?atmenu=payment&section=11", 1 => "Billing#Invoices#Receipts"),
    55 =>array( 0 => "billing_entity_invoice.php?atmenu=payment&section=11", 1 => "Billing#Invoices#Invoices"),
    56 =>array( 0 => "billing_entity_invoice_conf.php?atmenu=payment&section=11", 1 => "Billing#Invoices#Configuration"),
    57 =>array( 0 => "billing_entity_package.php?atmenu=package&section=12", 1 => "Billing#Package Offer#Add"),
    58 =>array( 0 => "billing_detail_package.php?section=12", 1 => "Billing#Package Offer#Details"),
    59 =>array( 0 => "billing_entity_service.php?section=13", 1 => "Billing#Recur Service#Account Service"),
    60 =>array( 0 => "billing_entity_subscription.php?section=13", 1 => "Billing#Recur Service#Subscriptions Service"),
    61 =>array( 0 => "billing_entity_subscriber_signup.php?section=13", 1 => "Billing#Recur Service#Subscriptions SIGNUP"),
    62 =>array( 0 => "billing_entity_subscriber.php?section=13", 1 => "Billing#Recur Service#Subscribers"),
    63 =>array( 0 => "billing_entity_autorefill.php?section=13", 1 => "Billing#Recur Service#AutoRefill Report"),
    64 =>array( 0 => "credit_transfer.php", 1 => "Billing#Balance Transfer"),
    65 =>array( 0 => "billing_entity_payment_configuration.php?atmenu=payment&section=10", 1 => "Billing#Payment Methods#Paypal & Others"),
    66 =>array( 0 => "billing_entity_strip_config.php", 1 => "Billing#Payment Methods#Stripe Config"),
    67 =>array( 0 => "billing_entity_authorize_config.php", 1 => "Billing#Payment Methods#Authorize.net Config"),
    68 =>array( 0 => "ebs_payment.php", 1 => "Billing#Payment Methods#EBS Payment Config"),
    69 =>array( 0 => "billing_entity_voucher.php?section=10", 1 => "Billing#Others#Vouchers"),
    70 =>array( 0 => "billing_currencies.php?section=10", 1 => "Billing#Others#Currency List"), 
    71 =>array( 0 => "billing_entity_mobile_topup.php", 1 => "Reports#Mobile TopUp Reports"), 
    72 =>array( 0 => "live-call-summery.php?section=6&type=tool&display=live_call&extdisplay=all", 1 => "Reports#Live Call Reports"),
    73 =>array( 0 => "call-log-customers.php?nodisplay=1&posted=1&section=5", 1 => "Reports#Call Reports#CDR's"),
    74 =>array( 0 => "call-count-reporting.php?nodisplay=1&posted=1&section=5", 1 => "Reports#Call Reports#Call Count"),
    75 =>array( 0 => "call-comp.php?section=5", 1 => "Reports#Call Reports#Compare Calls"),         
    76 =>array( 0 => "billing_trunk_report.php?section=5", 1 => "Reports#Trunk & Traffic#Trunk"),
    77 =>array( 0 => "call-daily-load.php?section=5", 1 => "Reports#Trunk & Traffic#Daily Traffic"),
    78 =>array( 0 => "call-last-month.php?section=5", 1 => "Reports#Trunk & Traffic#Monthy Traffic"),
    79 =>array( 0 => "call-dnid.php?nodisplay=1&posted=1&section=5", 1 => "Reports#Other Report#DNID"),
    80 =>array( 0 => "call-pnl-report.php?section=5", 1 => "Reports#Other Report#PNL"),
    81 =>array( 0 => "billing_transfer_report.php", 1 => "Reports#Other Report#Balance Reports"),  
    82 =>array( 0 => "billing_entity_sms_report.php", 1 => "Reports#Other Report#SMS Reports"),
    83 =>array( 0 => "billing_entity_provider.php?section=7", 1 => "Routing#Providers"),
    84 =>array( 0 => "billing_entity_trunk.php?section=7", 1 => "Routing#Trunks"),
    85 =>array( 0 => "billing_entity_prefix.php?section=7", 1 => "Routing#Prefixes"),
    86 =>array( 0 => "CC_ticket.php?section=4", 1 => "Support#Customer Tickets"),
    87 =>array( 0 => "billing_ticket_agent.php?section=4", 1 => "Support#Agent Tickets"),
    88 =>array( 0 => "CC_support_component.php?section=4", 1 => "Support#Ticket Components"),
    89 =>array( 0 => "CC_support.php?section=4", 1 => "Support#Support Boxes"),  
    90 =>array( 0 => "billing_entity_backup.php?form_action=ask-add&section=16", 1 => "Others#Database#Database Backup"),
    91 =>array( 0 => "billing_entity_restore.php?section=16", 1 => "Others#Database#Database Restore"),
    92 =>array( 0 => "billing_entity_mailtemplate.php?atmenu=mailtemplate&section=17&languages=en", 1 => "Others#Mail#Mail templates"),
    93 =>array( 0 => "billing_mass_mail.php?section=17", 1 => "Others#Mail#Mass Mail"),
    94 =>array( 0 => "billing_entity_alarm.php?section=16", 1 => "Others#Tools#Alarms"),
    95 =>array( 0 => "billing_entity_log_viewer.php?section=16", 1 => "Others#Tools#Users Activity"),
    96 =>array( 0 => "CC_musiconhold.php?section=16", 1 => "Others#Tools#MusicOnHold"),
    97 =>array( 0 => "CC_upload.php?section=16", 1 => "Others#Tools#Upload File"),
    98 =>array( 0 => "billing_logfile.php?section=16", 1 => "Others#Tools#Watch Log files"),
    99 =>array( 0 => "billing_data_archiving.php?section=16", 1 => "Others#Tools#Archiving"),
    100 =>array( 0 => "billing_asteriskinfo.php?section=16", 1 => "Others#Tools#Asterisk Info"),
    101 =>array( 0 => "billing_phpsysinfo.php?section=16", 1 => "Others#Tools#phpSysInfo"),
    102 =>array( 0 => "billing_phpinfo.php?section=16", 1 => "Others#Tools#phpInfo"),
    103 =>array( 0 => "billing_entity_monitor.php?section=16", 1 => "Others#Tools#Monitoring"),
    104 =>array( 0 => "billing_entity_callback.php?section=14", 1 => "CALLBACK#Add"),
    105 =>array( 0 => "billing_entity_server_group.php?section=14", 1 => "CALLBACK#Server Group"),
    106 =>array( 0 => "billing_entity_server.php?section=14", 1 => "CALLBACK#Server"),
    107 =>array( 0 => "billing_entity_campaign.php?section=15", 1 => "CAMPAIGNS#Autodialer"),
    108 =>array( 0 => "billing_chat.php", 1 => "Chat"),
    109 =>array( 0 => "billing_entity_config.php?form_action=list&atmenu=config&section=18", 1 => "System Settings#Global List"),
    110 =>array( 0 => "billing_entity_config_group.php?form_action=list&atmenu=configgroup&section=18", 1 => "System Settings#Group List"),
    111 =>array( 0 => "billing_entity_config_generate_confirm.php?section=18", 1 => "System Settings#Add agi-conf"),
    112 =>array( 0 => "phpconfig.php?dir=/etc/asterisk&section=18", 1 => "System Settings#Config Editor"),
    113 =>array( 0 => "PP_intro.php" , 1 => "Home#My Home")
);
$data ="";
$showdata = '<div id="breadcrumb">';

foreach($links as $line)
    {
        if ( preg_match("/".urlencode($accuiredlinks)."/", urlencode($line[0])) )
        {
             
            $dataarray = explode("#",$line[1]);
            
            for($i = 0; $i < count($dataarray);$i++)
            {
                $showdata .=  '<a href="#" title="Go to Home" class="tip-bottom">'.$dataarray[$i].'</a>';
            }
            
        }
    }
   $showdata .= '</div>'; 
     //<a href="#" title="Go to Home" class="tip-bottom"> Home</a> <a href="#" class="current">Tables</a> </div>
return $showdata;
}
/* **********************************************************New code added for links END************************************************* */
...
{
    echo "<a target=\"_blank\" href=\"billing_entity_call.php?form_action=ask-delete&id=" . $value . "\">";
...
function linktocustomer($value)
{
    ...
    if ($id > 0) {
        echo "<a href=\"billing_entity_card.php?form_action=ask-edit&id=$id\">$value</a>";
    } else {
        echo $value;
    }
}
...
function infocustomer_id($id)
{
    ...
    if (is_array($list_customer))
        ...
        $value = "";
    if ($id > 0) {
        echo "<a href=\"billing_card_info.php?id=$id\">$value</a>";
    } else {
        echo $value;
    }
}

//GET USER ID FROM USERAME new addition
function getuserid($username)
{
    $handle = DbConnect();
    $inst_table = new Table("cc_card", "id");
    $FG_TABLE_CLAUSE = "username = '$username'";
    $list_customer = $inst_table->Get_list($handle, $FG_TABLE_CLAUSE, "", "", "", "", "", "", "", 10);
    return   $list_customer[0]['id'];
...
function linktoagent($id)
{
    ...
    if (is_array($list_agent))
        ...
        $value = "";
    if ($id > 0) {
        return "<a href=\"billing_entity_agent.php?form_action=ask-edit&id=$id\">$value</a>";
    } else {
        return $value;
    }
}
...
function MDP_STRINGNUM($chrs = LEN_CARDNUMBER)
{
    $pwd = "";
    mt_srand((double) microtime() * 1000000);
    while (strlen($pwd) < $chrs) {
        $chr = chr(mt_rand(0, 255));
        if (preg_match("/^[0-9A-Za-z]$/i", $chr))
            $pwd = $pwd . $chr;
    };
...
function Display_Login_Button ($DBHandle, $id)
{
    ...
    $content = '<div  style="padding-right:20px;">
        <form id="goform" action="'.$link.'" method="POST" target="_blank">
            <input type="hidden" name="done" value="submit_log"/>
            <input type="hidden" name="pr_login" value="'.$username.'"/>
            <input type="hidden" name="pr_password" value="'.$password.'"/>
            <a class="btn btn-small btn-primary" href="javascript:;" onclick="javascript:$(\'#goform\').submit();" > '.gettext("GO TO CUSTOMER ACCOUNT").'</a>
        </form>
    </div>';
