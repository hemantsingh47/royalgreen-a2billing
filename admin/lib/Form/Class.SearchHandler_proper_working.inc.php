	...
	<div class="kt-portlet__head">
		<div class="kt-portlet__head-label">
			<h1 class="kt-portlet__head-title"> 
				<?php echo $this -> FG_FILTER_SEARCH_TOP_TEXT?>
...
<div class="col-md-12">
        ...
        <table class="widget-box" width="100%">
        <FORM METHOD="POST" ACTION="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>?s=<?php echo $processed['s']?>&t=<?php echo $processed['t']?>&order=<?php echo $processed['order']?>&sens=<?php echo $processed['sens']?>&current_page=<?php echo $processed['current_page']?>" class="kt-form">
        ...
        <?php if ($this -> FG_FILTER_SEARCH_1_TIME) { ?>
            <tr>
                <td align="left" class="widget-title">
            ...
            <tr>
				...
				<tr>
                  <td align="left" class="bgcolor_003">
                    ...
                    <select name="fromstatsday_sday_bis" class="form-control11">
                        <?php
                            for ($i=1;$i<=31;$i++) {
                     ...
                     <select name="fromstatsmonth_sday_bis" class="form-control13">
                    <?php
                        $year_actual = date("Y");
                        for ($i = $year_actual ; $i >= $year_actual - 10 ; $i--) {
                            if ($year_actual==$i) {
                    ...
                    &nbsp; &nbsp;<select name="tostatsday_sday_bis" class="form-control11">
                    <?php
                        for ($i=1;$i<=31;$i++) {
                    ...
                    ?>
                     ...
                     <select name="tostatsmonth_sday_bis" class="form-control13">
                    <?php
                        $year_actual = date("Y");
                        for ($i = $year_actual ; $i >= $year_actual - 10 ; $i--) {
                            if ($year_actual==$i) {
            ...
            <tr>
				...
				<tr>
                  <td align="left" class="bgcolor_003">
                    <table  border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tr><td class="fontstyle_searchoptions">&nbsp;
                    <select name="month_earlier" class="form-control13">
                        <?php
                            for ($i=3 ; $i<=12 ; $i++) {
        ...
        ?>
            <tr>
                <td class="widget-title" align="left">
                ...
                <tr><td class="fontstyle_searchoptions"><INPUT TYPE="text" NAME="<?php echo $one_compare[1]?>" value="<?php echo $processed[$one_compare[1]]?>" class="form-control"></td>
            ...
            <tr>
                <td class="widget-title" align="left">
                    <font class="fontstyle_003">&nbsp;&nbsp;<?php echo gettext("FROM")." ".$two_compare[0]?></font>
                </td>
				</tr>
				<tr>
					<td class="<?php echo $classright?>" align="left">
						<table class="table" style="margin-bottom:0">
							<tr>
								<td class="fontstyle_searchoptions" style="padding:0; border-top:0px; width: 40%;">
									 
							
								<INPUT TYPE="text" NAME="<?php echo $two_compare[1]?>" size="10" value="<?php echo $processed[$two_compare[1]]?>" class="form-control">
								</td>
							 
								
									<td style="padding:0; border-top:0px;" align="center">
										<label class="">
											<input type="radio" NAME="<?php echo $two_compare[2]?>" value="4" <?php if ($processed[$two_compare[2]]==4) {?>checked<?php }?>  />
											<label class="btn btn-default" for="<?php echo $two_compare[2]?>">&gt;</label>
											<span></span>
										</label>
									...
									<td style="padding:0; border-top:0px;" align="center">
										<label class="">
											<input type="radio" NAME="<?php echo $two_compare[2]?>" value="5" <?php if ($processed[$two_compare[2]]==5) {?>checked<?php }?>  />
											<label class="btn btn-default" for="<?php echo $two_compare[2]?>">&gt;=</label>
											<span></span>
										</label>
									</td>
									<td style="padding:0; border-top:0px;" align="center">
										<label class="">
											<input type="radio" NAME="<?php echo $two_compare[2]?>" value="1" <?php if ((!isset($processed[$two_compare[2]]))||($processed[$two_compare[2]]==1)) {?>checked<?php }?>  />
											<label class="btn btn-default" for="<?php echo $two_compare[2]?>">=</label>
											<span></span>
										</label>
									</td>
									<td class="fontstyle_searchoptions" align="center" style="padding:0; border-top:0px;">
										<label class="">
											<input type="radio" name="<?php echo $two_compare[2]?>" value="2" <?php if ($processed[$two_compare[2]]==2) {?>checked<?php }?> data-md-icheck />
											<label class="btn btn-default" for="<?php echo $two_compare[2]?>">&lt; =</label>
											<span></span>
										</label>
									</td>
									<td class="fontstyle_searchoptions" align="center" style="padding:0; border-top:0px;">
										<label class="">
										<input type="radio" name="<?php echo $two_compare[2]?>" value="3" <?php if ($processed[$two_compare[2]]==3) {?>checked<?php }?> data-md-icheck />
										<label class="btn btn-default"  for="<?php echo $two_compare[2]?>" class="inline-label">&lt;</label>
										<span></span>
										</label>
									</td>
				...
				<tr>
					<td class="widget-title" align="left">
                    <font class="fontstyle_003">&nbsp;&nbsp;<?php echo gettext("TO")." ".$two_compare[0]?></font>
					</td>
				</tr>
				<tr>
					<td class="<?php echo $classright?>" align="left">
						<table class="table" style="margin-bottom:0">
								...
								<tr>
									...
									<td class="fontstyle_searchoptions" style="padding:0; border-top:0px; width: 40%;">
										...
										<INPUT TYPE="text" NAME="<?php echo $two_compare[3]?>" size="10" value="<?php echo $processed[$two_compare[3]]?>" class="form-control" >
									</td>
									...
									<td  class="fontstyle_searchoptions" align="center" style="padding:0; border-top:0px;">
										<label class="">
											<input type="radio" name="<?php echo $two_compare[4]?>" value="4" <?php if ($processed[$two_compare[4]]==4) {?>checked<?php }?> />
											<label class="btn btn-default" for="<?php echo $two_compare[4]?>" >&gt;</label>
											<span></span>
										</label>
									</td>
									...
									<td   class="fontstyle_searchoptions" align="center" style="padding:0; border-top:0px;">
										<label class="">
											<input type="radio" name="<?php echo $two_compare[4]?>" value="5" <?php if ($processed[$two_compare[4]]==5) {?>checked<?php }?>  />
											<label class="btn btn-default" for="<?php echo $two_compare[4]?>" >&gt; =</label>
											<span></span>
										</label>
									</td>
									<td class="fontstyle_searchoptions" align="center" style="padding:0; border-top:0px;">
										<label class="">
											<input type="radio" name="<?php echo $two_compare[4]?>" value="2" <?php if ($processed[$two_compare[4]]==1) {?>checked<?php }?> data-md-icheck />
											<label class="btn btn-default" for="<?php echo $two_compare[4]?>" >&lt; =</label>
											<span></span>
										</label>
									</td>
									<td   class="fontstyle_searchoptions" align="center" style="padding:0; border-top:0px;">
										<label class="">
											<input type="radio" name="<?php echo $two_compare[4]?>" value="3" <?php if ($processed[$two_compare[4]]==3) {?>checked<?php }?> data-md-icheck />
											<label class="btn btn-default" for="<?php echo $two_compare[4]?>" class="inline-label">&lt; </label>
											<span></span>
										</label>
									</td>
            ...
            <tr>
                ...
                ?>
                    <select NAME="<?php echo $selects[2]?>" size="1" class="form-control13" style="width:40%">
                        <option value=''><?php echo $selects[0]?></option>
                <?php
                     foreach ($selects[1] as $recordset) {
                ?>
                        <option class=form-control" value='<?php echo $recordset[0]?>'  <?php if ($processed[$selects[2]]==$recordset[0]) echo 'selected="selected"'?>><?php echo $recordset[1]; if (strlen($recordset[2])>0) echo ' - '.$recordset[2]; ?></option>
                <?php 	 }
                ?>
                    </select>
                <?php
		...
		<div class="col-md-12">
		 ...
		 <div class="modal-footer">
				...
				<input class="btn btn-primary" name="image16"  value=" <?php echo gettext("Search");?>  " type="submit" style="width:73px;">
				...
				<!--<input type="image"  name="image16" align="top" border="0" src="<?php echo Images_Path_Main;?>/button-search.gif" />-->
                    ...
                    <?php if (isset($_SESSION[$this->FG_FILTER_SEARCH_SESSION_NAME]) && strlen($_SESSION[$this->FG_FILTER_SEARCH_SESSION_NAME])>10 ) { ?>
                        - <a href="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>?cancelsearch=true" class="btn btn-danger"><?php echo gettext("Cancel Search");?></a>&nbsp;
                        <?php if ($this -> FG_FILTER_SEARCH_DELETE_ALL) { ?>
                            - <a href="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL)?>?deleteselected=true" onclick="return confirm('<?php echo "Are you sure to delete ".$this -> FG_NB_RECORD." selected records?";?>');" class="btn btn-danger"><?php echo gettext("Delete All");?></a>
                        <?php } ?>
                    <?php } ?>
...
<tr>
          <td align="left" class="searchhandler_table4_td1">
                  ...
                  <td align="left" class="searchhandler_table4_td1">
                                ...
                                <input type="radio" NAME="type[upd_disconnectcharge_after]" value="3" <?php if ($type[upd_disconnectcharge_after]==3) {?>checked<?php }?>> <?php echo gettext("Subtract");?>
                                </font>
                        </td>
                </tr>
