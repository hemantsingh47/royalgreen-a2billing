...
<div class="kt-subheader   kt-grid__item" id="kt_subheader"><div class="kt-container  kt-container--fluid "><div class="kt-subheader__main"><h3 class="kt-subheader__title"> User </h3><span class="kt-subheader__separator kt-hidden"></span><div class="kt-subheader__breadcrumbs"><a href="#" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
	...
	<a class="btn btn-success btn-small" href="<?php echo $this -> FG_LIST_ADDING_BUTTON_LINK1 ?>">
	...
	<?php 
		...
		{
	?>
	<a class="btn btn-success btn-small" href="<?php echo $this -> FG_LIST_ADDING_BUTTON_LINK2 ?>">
                        ...
                        <?php if ($this->CV_DISPLAY_RECORD_LIMIT){ ?>
                            ...
                            <?php
                             ...
                             ?> 
										...
										<select name="mydisplaylimit" size="1" class="custom-select custom-select-sm form-control form-control-sm" style="margin-top: 10px;width:70px;">
										...
										&nbsp; &nbsp; &nbsp; 
										<input class="btn btn-brand btn-elevate btn-icon-sm"  value=" <?php echo gettext("GO");?> " type="SUBMIT">
										&nbsp; &nbsp;
					 ...
					 <INPUT type="hidden" name="form_action" value="<?php echo $this->FG_FILTER_FORM_ACTION ?>">
                                    ...
                                    { ?>
                                       &nbsp;
                                        ...
                                        <INPUT type="text" name="filterprefix2" value="" class="md-input label-fixed">
                                    ...
                                    ?>
                                    <input type="SUBMIT" value="<?php echo gettext("APPLY FILTER ");?>" class="btn btn-success" style="margin-top: -10px;margin-right: 3px;"/> 
                                </FORM>
                            </div>
						<?php } ?>
                      </table>
                                ...
                                <?php if($this->FG_OTHER_BUTTON1)
                                {
                                    ...
                                    <a href="<?php
                                        ...
                                        if (strlen($this -> FG_OTHER_BUTTON1_IMG)==0) {
                                            echo '"'.$extra_html.'> '.'<span class="btn btn-default btn-mini">'.$this->FG_OTHER_BUTTON1_ALT.'</span>';
                                        } else {                                                                                                         
                                            //<img src=" echo $this -> FG_OTHER_BUTTON1_IMG"  border="0" title=" echo $this->FG_OTHER_BUTTON1_ALT" alt=" echo $this->FG_OTHER_BUTTON1_ALT">
                                            ?>"<?php echo $extra_html ?>> <i class="flaticon2-edit <?php echo $this->FG_OTHER_BUTTON1_IMG; ?>" title="<?php echo $this->FG_OTHER_BUTTON1_ALT?>"></i><?php
                                        }
                                        ?></a>
                                <?php }
                                    }
