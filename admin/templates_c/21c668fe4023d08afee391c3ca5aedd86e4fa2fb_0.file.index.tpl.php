<?php
/* Smarty version 3.1.33, created on 2019-09-20 08:33:07
  from '/var/www/html/crm/admin/Public/templates/default/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d848ec39a9f21_74334503',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '21c668fe4023d08afee391c3ca5aedd86e4fa2fb' => 
    array (
      0 => '/var/www/html/crm/admin/Public/templates/default/index.tpl',
      1 => 1568968352,
      2 => 'file',
    ),
  ),
...
function content_5d848ec39a9f21_74334503 (Smarty_Internal_Template $_smarty_tpl) {
?><HTML>
<HEAD>
...
>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<?php if (($_smarty_tpl->tpl_vars['CSS_NAME']->value != '' && $_smarty_tpl->tpl_vars['CSS_NAME']->value != "default")) {?>
			   <link href="templates/default/css/<?php echo $_smarty_tpl->tpl_vars['CSS_NAME']->value;?>
...
">
										...
										<!--<input class="form-control" type="text" id="login_username" name="pr_login"  placeholder="Username" style="color: #f6fbff;"/>-->
...
">
									...
									<div class=""></div>
										...
										<!--<input class="form-control" input type="password" id="login_password" name="pr_password" placeholder="Password" style="color: #f6fbff;"/>-->
									</div>
    ...
    background: #2f96b4;
    border: 0;">
                                        <option  value="english" name="gb" <?php  if(LANGUAGE=="english") echo "selected";?> ><?php echo gettext("English")?></option>
                                        <option  value="french" name="fr" <?php  if(LANGUAGE=="french") echo "selected";?> ><?php echo gettext("French")?></option>
                                        <option  value="romanian" name="ro" <?php  if(LANGUAGE=="romanian") echo "selected";?> ><?php echo gettext("Romanian")?></option>
                                        <option  value="greek" name="gr" <?php  if(LANGUAGE=="greek") echo "selected";?> ><?php echo gettext("Greek")?></option>
                                        <option  value="brazilian" name="br" <?php  if(LANGUAGE=="brazilian") echo "selected";?>><?php echo gettext("Brazilian")?></option>
                                    </select>
										</div>
...
<!--default theme login -->
	...
	<tr>
		<td ><img src="templates/<?php echo $_smarty_tpl->tpl_vars['SKIN_NAME']->value;?>
		...
		<td align="center" style="padding-right: 10px">
            ...
            <td>
                <select name="ui_language"  id="ui_language" class="icon-menu form_input_select">
                    <option style="background-image:url(templates/<?php echo $_smarty_tpl->tpl_vars['SKIN_NAME']->value;?>
...
<!-- css for footer -->
  <!-- <div id="footer_index"><div style=" border: solid 1px #F4F4F4; text-align:center;"><?php echo $_smarty_tpl->tpl_vars['COPYRIGHT']->value;?>
</div></div>
