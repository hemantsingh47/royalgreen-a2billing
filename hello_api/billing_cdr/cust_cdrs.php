...
{       
		...
		$Rates = ($amnt)*($Rates).' '.$to;
		  ...
		  array_push($array_result,array("called_user" => $called_user, "country" =>$country, "Rates" =>$Rates, "duration" => $duration, "cost" => $cost)); 
		  }
