...
//Constructor..
public function BulkSender ($host,$port,$username,$password,$sender, $message,$mobile,$msgtype,$dlr)
{
    $this->host=$host;
    $this->port=$port;
...
//Call The Constructor TO SEND MESSAGE
/*$obj = new Sender("IP","Port","","","Tester"," "?? ??? ?? ","919990001245,"2","1");
$obj->Submit (); */
?>
