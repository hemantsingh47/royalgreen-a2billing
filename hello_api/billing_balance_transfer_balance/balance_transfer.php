                      ...
                      // update transfer account
                        ...
                        if($query_transfer_card_update_result)
                        {
                           ...
                           $credit_transfer = $inst_table -> SQLExec($DBHandle, $query_transfer_credit);*/
                            ...
                            $credit_sender = '-'.$credit;
                            $query_transfer_credit= "INSERT INTO cc_credit(transferFrom,transferTo,Amount,date,time,result_value)VALUES('".$username."','".$transferaccount."','".$credit_sender."','".$cdate."','".$ctime."','".$result_message."')";
                            $credit_transfer = $inst_table -> SQLExec($DBHandle, $query_transfer_credit);
                           
                            $query_transfer_credit= "INSERT INTO cc_credit(transferFrom,transferTo,Amount,date,time,result_value)VALUES('".$transferaccount."','".$username."','".$credit."','".$cdate."','".$ctime."','".$result_message."')";
                            $credit_transfer = $inst_table -> SQLExec($DBHandle, $query_transfer_credit);
